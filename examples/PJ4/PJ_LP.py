...
def senGradLP(control_param, l, f, g):
	...
	# constraints += [0.5*lambda_1[0, 0] - 0.5*lambda_1[0, 1] + 2*lambda_1[0, 2] - lambda_1[0, 3] + 0.25*lambda_1[0, 4] + 0.25*lambda_1[0, 5] + 4*lambda_1[0, 6] + lambda_1[0, 7] - 0.25*lambda_1[0, 8] + 1.0*lambda_1[0, 9] - 1.0*lambda_1[0, 10] - 0.5*lambda_1[0, 11] + 0.5*lambda_1[0, 12] - 2*lambda_1[0, 13] >= B[0, 0]]
	constraints += [0.5*lambda_1[0, 0] - 0.5*lambda_1[0, 1] + 2*lambda_1[0, 2] - lambda_1[0, 3] + 0.25*lambda_1[0, 4] + 0.25*lambda_1[0, 5] + 4*lambda_1[0, 6] + lambda_1[0, 7] - 0.25*lambda_1[0, 8] + 1.0*lambda_1[0, 9] - 1.0*lambda_1[0, 10] - 0.5*lambda_1[0, 11] + 0.5*lambda_1[0, 12] - 2*lambda_1[0, 13] == B[0, 0]]
	...
	constraints += [lambda_1[0, 4] + lambda_1[0, 5] - lambda_1[0, 8] == B[0, 3]]
	...
	# constraints += [-0.5*lambda_3[0, 0] - 0.3*lambda_3[0, 1] + 1.5*lambda_3[0, 2] + 1.3*lambda_3[0, 3] + 0.25*lambda_3[0, 4] + 0.09*lambda_3[0, 5] + 2.25*lambda_3[0, 6] + 1.69*lambda_3[0, 7] + 0.15*lambda_3[0, 8] - 0.75*lambda_3[0, 9] - 0.45*lambda_3[0, 10] - 0.65*lambda_3[0, 11] - 0.39*lambda_3[0, 12] + 1.95*lambda_3[0, 13] <= -B[0, 0] - 0.01 + objc]
	...
	constraints += [lambda_3[0, 4] + 1.0*lambda_3[0, 6] - lambda_3[0, 9] == -B[0, 3]]
	...
	constraints += [lambda_3[0, 5] + 1.0*lambda_3[0, 7] - lambda_3[0, 12] == -B[0, 4]]
...
def BarrierConsGenerate():
	...
	lhs_init = B * monomial_list - Matrix([0.1])
	...
	lie_poly_list = [x1+4, x2+4, 4-x1, 4-x2]
	...
	lhs_unsafe = -B*monomial_list - Matrix([0.1])
