...
def LyaSDP(c0, c1, c2, lamb, eps, SVG_only=False):
	...
	constraints += [ Y[27, 27]  >=  -V[0, 23]*t2[0, 0] - objc ]
	constraints += [ Y[27, 27]  <=  -V[0, 23]*t2[0, 0] + objc ]
	constraints += [ Y[0, 5] + Y[5, 0]  >=  -eps*V[0, 1]*t1[0, 10] - objc ]
	constraints += [ Y[0, 5] + Y[5, 0]  <=  -eps*V[0, 1]*t1[0, 10] + objc ]
	constraints += [ Y[0, 26] + Y[5, 6] + Y[6, 5] + Y[26, 0]  >=  -eps*V[0, 22]*t1[0, 10] - V[0, 18]*t2[0, 15] - objc ]
	constraints += [ Y[0, 26] + Y[5, 6] + Y[6, 5] + Y[26, 0]  <=  -eps*V[0, 22]*t1[0, 10] - V[0, 18]*t2[0, 15] + objc ]
	constraints += [ Y[5, 27] + Y[6, 26] + Y[26, 6] + Y[27, 5]  >=  -eps*V[0, 1]*t1[0, 7] - objc ]
	constraints += [ Y[5, 27] + Y[6, 26] + Y[26, 6] + Y[27, 5]  <=  -eps*V[0, 1]*t1[0, 7] + objc ]
	constraints += [ Y[26, 27] + Y[27, 26]  >=  -eps*V[0, 22]*t1[0, 7] - V[0, 18]*t2[0, 0] - objc ]
	constraints += [ Y[26, 27] + Y[27, 26]  <=  -eps*V[0, 22]*t1[0, 7] - V[0, 18]*t2[0, 0] + objc ]
	constraints += [ Y[0, 21] + Y[5, 5] + Y[21, 0]  >=  -eps*V[0, 17]*t1[0, 10] + n - objc ]
	constraints += [ Y[0, 21] + Y[5, 5] + Y[21, 0]  <=  -eps*V[0, 17]*t1[0, 10] + n + objc ]
	constraints += [ Y[5, 26] + Y[6, 21] + Y[21, 6] + Y[26, 5]  >=  -V[0, 2]*t2[0, 8] - objc ]
	constraints += [ Y[5, 26] + Y[6, 21] + Y[21, 6] + Y[26, 5]  <=  -V[0, 2]*t2[0, 8] + objc ]
	constraints += [ Y[21, 27] + Y[26, 26] + Y[27, 21]  >=  -eps*V[0, 17]*t1[0, 7] - V[0, 23]*t2[0, 8] - objc ]
	constraints += [ Y[21, 27] + Y[26, 26] + Y[27, 21]  <=  -eps*V[0, 17]*t1[0, 7] - V[0, 23]*t2[0, 8] + objc ]
	constraints += [ Y[5, 21] + Y[21, 5]  >=  -eps*V[0, 1]*t1[0, 0] - objc ]
	constraints += [ Y[5, 21] + Y[21, 5]  <=  -eps*V[0, 1]*t1[0, 0] + objc ]
	constraints += [ Y[21, 26] + Y[26, 21]  >=  -eps*V[0, 22]*t1[0, 0] - V[0, 18]*t2[0, 8] - objc ]
	constraints += [ Y[21, 26] + Y[26, 21]  <=  -eps*V[0, 22]*t1[0, 0] - V[0, 18]*t2[0, 8] + objc ]
	constraints += [ Y[21, 21]  >=  -eps*V[0, 17]*t1[0, 0] - objc ]
	constraints += [ Y[21, 21]  <=  -eps*V[0, 17]*t1[0, 0] + objc ]
	constraints += [ Y[0, 4] + Y[4, 0]  >=  -lamb*V[0, 0]*t0[0, 7] - objc ]
	constraints += [ Y[0, 4] + Y[4, 0]  <=  -lamb*V[0, 0]*t0[0, 7] + objc ]
	constraints += [ Y[0, 25] + Y[4, 6] + Y[6, 4] + Y[25, 0]  >=  -lamb*V[0, 21]*t0[0, 7] - V[0, 14]*t2[0, 15] - objc ]
	constraints += [ Y[0, 25] + Y[4, 6] + Y[6, 4] + Y[25, 0]  <=  -lamb*V[0, 21]*t0[0, 7] - V[0, 14]*t2[0, 15] + objc ]
	constraints += [ Y[4, 27] + Y[6, 25] + Y[25, 6] + Y[27, 4]  ==  0 ]
	constraints += [ Y[25, 27] + Y[27, 25]  >=  -V[0, 14]*t2[0, 0] - objc ]
	constraints += [ Y[25, 27] + Y[27, 25]  <=  -V[0, 14]*t2[0, 0] + objc ]
	constraints += [ Y[0, 20] + Y[4, 5] + Y[5, 4] + Y[20, 0]  >=  -eps*V[0, 13]*t1[0, 10] - lamb*V[0, 16]*t0[0, 7] - objc ]
	constraints += [ Y[0, 20] + Y[4, 5] + Y[5, 4] + Y[20, 0]  <=  -eps*V[0, 13]*t1[0, 10] - lamb*V[0, 16]*t0[0, 7] + objc ]
	constraints += [ Y[4, 26] + Y[5, 25] + Y[6, 20] + Y[20, 6] + Y[25, 5] + Y[26, 4]  ==  0 ]
	constraints += [ Y[20, 27] + Y[25, 26] + Y[26, 25] + Y[27, 20]  >=  -eps*V[0, 13]*t1[0, 7] - objc ]
	constraints += [ Y[20, 27] + Y[25, 26] + Y[26, 25] + Y[27, 20]  <=  -eps*V[0, 13]*t1[0, 7] + objc ]
	constraints += [ Y[4, 21] + Y[5, 20] + Y[20, 5] + Y[21, 4]  ==  0 ]
	constraints += [ Y[20, 26] + Y[21, 25] + Y[25, 21] + Y[26, 20]  >=  -V[0, 14]*t2[0, 8] - objc ]
	constraints += [ Y[20, 26] + Y[21, 25] + Y[25, 21] + Y[26, 20]  <=  -V[0, 14]*t2[0, 8] + objc ]
	constraints += [ Y[20, 21] + Y[21, 20]  >=  -eps*V[0, 13]*t1[0, 0] - objc ]
	constraints += [ Y[20, 21] + Y[21, 20]  <=  -eps*V[0, 13]*t1[0, 0] + objc ]
	constraints += [ Y[0, 16] + Y[4, 4] + Y[16, 0]  >=  -lamb*V[0, 12]*t0[0, 7] + n - objc ]
	constraints += [ Y[0, 16] + Y[4, 4] + Y[16, 0]  <=  -lamb*V[0, 12]*t0[0, 7] + n + objc ]
	constraints += [ Y[4, 25] + Y[6, 16] + Y[16, 6] + Y[25, 4]  >=  -V[0, 2]*t2[0, 7] - objc ]
	constraints += [ Y[4, 25] + Y[6, 16] + Y[16, 6] + Y[25, 4]  <=  -V[0, 2]*t2[0, 7] + objc ]
	constraints += [ Y[16, 27] + Y[25, 25] + Y[27, 16]  >=  -V[0, 23]*t2[0, 7] - objc ]
	constraints += [ Y[16, 27] + Y[25, 25] + Y[27, 16]  <=  -V[0, 23]*t2[0, 7] + objc ]
	constraints += [ Y[4, 20] + Y[5, 16] + Y[16, 5] + Y[20, 4]  >=  -eps*V[0, 1]*t1[0, 4] - objc ]
	constraints += [ Y[4, 20] + Y[5, 16] + Y[16, 5] + Y[20, 4]  <=  -eps*V[0, 1]*t1[0, 4] + objc ]
	constraints += [ Y[16, 26] + Y[20, 25] + Y[25, 20] + Y[26, 16]  >=  -eps*V[0, 22]*t1[0, 4] - V[0, 18]*t2[0, 7] - objc ]
	constraints += [ Y[16, 26] + Y[20, 25] + Y[25, 20] + Y[26, 16]  <=  -eps*V[0, 22]*t1[0, 4] - V[0, 18]*t2[0, 7] + objc ]
	constraints += [ Y[16, 21] + Y[20, 20] + Y[21, 16]  >=  -eps*V[0, 17]*t1[0, 4] - objc ]
	constraints += [ Y[16, 21] + Y[20, 20] + Y[21, 16]  <=  -eps*V[0, 17]*t1[0, 4] + objc ]
	constraints += [ Y[4, 16] + Y[16, 4]  >=  -lamb*V[0, 0]*t0[0, 0] - objc ]
	constraints += [ Y[4, 16] + Y[16, 4]  <=  -lamb*V[0, 0]*t0[0, 0] + objc ]
	constraints += [ Y[16, 25] + Y[25, 16]  >=  -lamb*V[0, 21]*t0[0, 0] - V[0, 14]*t2[0, 7] - objc ]
	constraints += [ Y[16, 25] + Y[25, 16]  <=  -lamb*V[0, 21]*t0[0, 0] - V[0, 14]*t2[0, 7] + objc ]
	constraints += [ Y[16, 20] + Y[20, 16]  >=  -eps*V[0, 13]*t1[0, 4] - lamb*V[0, 16]*t0[0, 0] - objc ]
	constraints += [ Y[16, 20] + Y[20, 16]  <=  -eps*V[0, 13]*t1[0, 4] - lamb*V[0, 16]*t0[0, 0] + objc ]
	constraints += [ Y[16, 16]  >=  -lamb*V[0, 12]*t0[0, 0] - objc ]
	constraints += [ Y[16, 16]  <=  -lamb*V[0, 12]*t0[0, 0] + objc ]
	constraints += [ Y[0, 3] + Y[3, 0]  >=  -V[0, 2]*t2[0, 14] - 0.5*V[0, 5] - objc ]
	constraints += [ Y[0, 3] + Y[3, 0]  <=  -V[0, 2]*t2[0, 14] - 0.5*V[0, 5] + objc ]
	constraints += [ Y[0, 24] + Y[3, 6] + Y[6, 3] + Y[24, 0]  >=  -2*V[0, 11]*t2[0, 15] - V[0, 23]*t2[0, 14] - 1.0*V[0, 26] - objc ]
	...
	constraints += [ Y[24, 27] + Y[27, 24]  >=  -2*V[0, 11]*t2[0, 0] - V[0, 23]*t2[0, 10] - 1.0*V[0, 26] - objc ]
	constraints += [ Y[24, 27] + Y[27, 24]  <=  -2*V[0, 11]*t2[0, 0] - V[0, 23]*t2[0, 10] - 1.0*V[0, 26] + objc ]
	constraints += [ Y[0, 19] + Y[3, 5] + Y[5, 3] + Y[19, 0]  >=  -eps*V[0, 10]*t1[0, 10] - 0.5*V[0, 3] - V[0, 18]*t2[0, 14] - 0.5*V[0, 25] - objc ]
	constraints += [ Y[0, 19] + Y[3, 5] + Y[5, 3] + Y[19, 0]  <=  -eps*V[0, 10]*t1[0, 10] - 0.5*V[0, 3] - V[0, 18]*t2[0, 14] - 0.5*V[0, 25] + objc ]
	constraints += [ Y[3, 26] + Y[5, 24] + Y[6, 19] + Y[19, 6] + Y[24, 5] + Y[26, 3]  >=  -0.5*V[0, 4] - 0.5*V[0, 24] - objc ]
	constraints += [ Y[3, 26] + Y[5, 24] + Y[6, 19] + Y[19, 6] + Y[24, 5] + Y[26, 3]  <=  -0.5*V[0, 4] - 0.5*V[0, 24] + objc ]
	constraints += [ Y[19, 27] + Y[24, 26] + Y[26, 24] + Y[27, 19]  >=  -eps*V[0, 10]*t1[0, 7] - V[0, 18]*t2[0, 10] - 1.0*V[0, 25] - objc ]
	constraints += [ Y[19, 27] + Y[24, 26] + Y[26, 24] + Y[27, 19]  <=  -eps*V[0, 10]*t1[0, 7] - V[0, 18]*t2[0, 10] - 1.0*V[0, 25] + objc ]
	constraints += [ Y[3, 21] + Y[5, 19] + Y[19, 5] + Y[21, 3]  >=  -V[0, 2]*t2[0, 4] - 0.5*V[0, 19] - objc ]
	constraints += [ Y[3, 21] + Y[5, 19] + Y[19, 5] + Y[21, 3]  <=  -V[0, 2]*t2[0, 4] - 0.5*V[0, 19] + objc ]
	constraints += [ Y[19, 26] + Y[21, 24] + Y[24, 21] + Y[26, 19]  >=  -2*V[0, 11]*t2[0, 8] - 1.0*V[0, 20] - V[0, 23]*t2[0, 4] - objc ]
	constraints += [ Y[19, 26] + Y[21, 24] + Y[24, 21] + Y[26, 19]  <=  -2*V[0, 11]*t2[0, 8] - 1.0*V[0, 20] - V[0, 23]*t2[0, 4] + objc ]
	constraints += [ Y[19, 21] + Y[21, 19]  >=  -eps*V[0, 10]*t1[0, 0] - V[0, 18]*t2[0, 4] - objc ]
	constraints += [ Y[19, 21] + Y[21, 19]  <=  -eps*V[0, 10]*t1[0, 0] - V[0, 18]*t2[0, 4] + objc ]
	constraints += [ Y[0, 15] + Y[3, 4] + Y[4, 3] + Y[15, 0]  >=  -lamb*V[0, 9]*t0[0, 7] + 0.5*V[0, 4] - V[0, 14]*t2[0, 14] - 0.5*V[0, 24] - objc ]
	constraints += [ Y[0, 15] + Y[3, 4] + Y[4, 3] + Y[15, 0]  <=  -lamb*V[0, 9]*t0[0, 7] + 0.5*V[0, 4] - V[0, 14]*t2[0, 14] - 0.5*V[0, 24] + objc ]
	constraints += [ Y[3, 25] + Y[4, 24] + Y[6, 15] + Y[15, 6] + Y[24, 4] + Y[25, 3]  >=  -0.5*V[0, 3] + 0.5*V[0, 25] - objc ]
	constraints += [ Y[3, 25] + Y[4, 24] + Y[6, 15] + Y[15, 6] + Y[24, 4] + Y[25, 3]  <=  -0.5*V[0, 3] + 0.5*V[0, 25] + objc ]
	constraints += [ Y[15, 27] + Y[24, 25] + Y[25, 24] + Y[27, 15]  >=  -V[0, 14]*t2[0, 10] - 1.0*V[0, 24] - objc ]
	...
	constraints += [ Y[15, 25] + Y[16, 24] + Y[24, 16] + Y[25, 15]  >=  -2*V[0, 11]*t2[0, 7] - 1.0*V[0, 15] - objc ]
	constraints += [ Y[15, 25] + Y[16, 24] + Y[24, 16] + Y[25, 15]  <=  -2*V[0, 11]*t2[0, 7] - 1.0*V[0, 15] + objc ]
	constraints += [ Y[15, 20] + Y[16, 19] + Y[19, 16] + Y[20, 15]  >=  -eps*V[0, 10]*t1[0, 4] - objc ]
	constraints += [ Y[15, 20] + Y[16, 19] + Y[19, 16] + Y[20, 15]  <=  -eps*V[0, 10]*t1[0, 4] + objc ]
	constraints += [ Y[15, 16] + Y[16, 15]  >=  -lamb*V[0, 9]*t0[0, 0] - objc ]
	constraints += [ Y[15, 16] + Y[16, 15]  <=  -lamb*V[0, 9]*t0[0, 0] + objc ]
	constraints += [ Y[0, 12] + Y[3, 3] + Y[12, 0]  >=  n - 2*V[0, 11]*t2[0, 14] - 0.5*V[0, 23] - objc ]
	constraints += [ Y[0, 12] + Y[3, 3] + Y[12, 0]  <=  n - 2*V[0, 11]*t2[0, 14] - 0.5*V[0, 23] + objc ]
	constraints += [ Y[3, 24] + Y[6, 12] + Y[12, 6] + Y[24, 3]  >=  -V[0, 2]*t2[0, 6] - objc ]
	...
	constraints += [ Y[12, 12]  >=  -2*V[0, 11]*t2[0, 1] - objc ]
	constraints += [ Y[12, 12]  <=  -2*V[0, 11]*t2[0, 1] + objc ]
	constraints += [ Y[0, 2] + Y[2, 0]  >=  -eps*V[0, 1]*t1[0, 11] - 0.5*V[0, 4] - objc ]
	constraints += [ Y[0, 2] + Y[2, 0]  <=  -eps*V[0, 1]*t1[0, 11] - 0.5*V[0, 4] + objc ]
	constraints += [ Y[0, 23] + Y[2, 6] + Y[6, 2] + Y[23, 0]  >=  -eps*V[0, 22]*t1[0, 11] + 0.5*V[0, 3] - V[0, 10]*t2[0, 15] - 0.5*V[0, 25] - objc ]
	constraints += [ Y[0, 23] + Y[2, 6] + Y[6, 2] + Y[23, 0]  <=  -eps*V[0, 22]*t1[0, 11] + 0.5*V[0, 3] - V[0, 10]*t2[0, 15] - 0.5*V[0, 25] + objc ]
	constraints += [ Y[2, 27] + Y[6, 23] + Y[23, 6] + Y[27, 2]  >=  -eps*V[0, 1]*t1[0, 6] + 0.5*V[0, 24] - objc ]
	constraints += [ Y[2, 27] + Y[6, 23] + Y[23, 6] + Y[27, 2]  <=  -eps*V[0, 1]*t1[0, 6] + 0.5*V[0, 24] + objc ]
	constraints += [ Y[23, 27] + Y[27, 23]  >=  -eps*V[0, 22]*t1[0, 6] - V[0, 10]*t2[0, 0] - objc ]
	constraints += [ Y[23, 27] + Y[27, 23]  <=  -eps*V[0, 22]*t1[0, 6] - V[0, 10]*t2[0, 0] + objc ]
	constraints += [ Y[0, 18] + Y[2, 5] + Y[5, 2] + Y[18, 0]  >=  -2*eps*V[0, 8]*t1[0, 10] - eps*V[0, 17]*t1[0, 11] - 1.0*V[0, 20] - objc ]
	constraints += [ Y[0, 18] + Y[2, 5] + Y[5, 2] + Y[18, 0]  <=  -2*eps*V[0, 8]*t1[0, 10] - eps*V[0, 17]*t1[0, 11] - 1.0*V[0, 20] + objc ]
	constraints += [ Y[2, 26] + Y[5, 23] + Y[6, 18] + Y[18, 6] + Y[23, 5] + Y[26, 2]  >=  -V[0, 2]*t2[0, 13] - 0.5*V[0, 5] + 0.5*V[0, 19] - objc ]
	constraints += [ Y[2, 26] + Y[5, 23] + Y[6, 18] + Y[18, 6] + Y[23, 5] + Y[26, 2]  <=  -V[0, 2]*t2[0, 13] - 0.5*V[0, 5] + 0.5*V[0, 19] + objc ]
	constraints += [ Y[18, 27] + Y[23, 26] + Y[26, 23] + Y[27, 18]  >=  -2*eps*V[0, 8]*t1[0, 7] - eps*V[0, 17]*t1[0, 6] - V[0, 23]*t2[0, 13] - 1.0*V[0, 26] - objc ]
	constraints += [ Y[18, 27] + Y[23, 26] + Y[26, 23] + Y[27, 18]  <=  -2*eps*V[0, 8]*t1[0, 7] - eps*V[0, 17]*t1[0, 6] - V[0, 23]*t2[0, 13] - 1.0*V[0, 26] + objc ]
	constraints += [ Y[2, 21] + Y[5, 18] + Y[18, 5] + Y[21, 2]  >=  -eps*V[0, 1]*t1[0, 5] - 0.5*V[0, 4] - objc ]
	constraints += [ Y[2, 21] + Y[5, 18] + Y[18, 5] + Y[21, 2]  <=  -eps*V[0, 1]*t1[0, 5] - 0.5*V[0, 4] + objc ]
	constraints += [ Y[18, 26] + Y[21, 23] + Y[23, 21] + Y[26, 18]  >=  -eps*V[0, 22]*t1[0, 5] - V[0, 10]*t2[0, 8] - V[0, 18]*t2[0, 13] - 1.0*V[0, 25] - objc ]
	constraints += [ Y[18, 26] + Y[21, 23] + Y[23, 21] + Y[26, 18]  <=  -eps*V[0, 22]*t1[0, 5] - V[0, 10]*t2[0, 8] - V[0, 18]*t2[0, 13] - 1.0*V[0, 25] + objc ]
	constraints += [ Y[18, 21] + Y[21, 18]  >=  -2*eps*V[0, 8]*t1[0, 0] - eps*V[0, 17]*t1[0, 5] - 1.0*V[0, 20] - objc ]
	constraints += [ Y[18, 21] + Y[21, 18]  <=  -2*eps*V[0, 8]*t1[0, 0] - eps*V[0, 17]*t1[0, 5] - 1.0*V[0, 20] + objc ]
	constraints += [ Y[0, 14] + Y[2, 4] + Y[4, 2] + Y[14, 0]  >=  -eps*V[0, 13]*t1[0, 11] - lamb*V[0, 7]*t0[0, 7] - 0.5*V[0, 5] - 0.5*V[0, 19] - objc ]
	constraints += [ Y[0, 14] + Y[2, 4] + Y[4, 2] + Y[14, 0]  <=  -eps*V[0, 13]*t1[0, 11] - lamb*V[0, 7]*t0[0, 7] - 0.5*V[0, 5] - 0.5*V[0, 19] + objc ]
	constraints += [ Y[2, 25] + Y[4, 23] + Y[6, 14] + Y[14, 6] + Y[23, 4] + Y[25, 2]  >=  1.0*V[0, 15] - 1.0*V[0, 26] - objc ]
	constraints += [ Y[2, 25] + Y[4, 23] + Y[6, 14] + Y[14, 6] + Y[23, 4] + Y[25, 2]  <=  1.0*V[0, 15] - 1.0*V[0, 26] + objc ]
	constraints += [ Y[14, 27] + Y[23, 25] + Y[25, 23] + Y[27, 14]  >=  -eps*V[0, 13]*t1[0, 6] - objc ]
	constraints += [ Y[14, 27] + Y[23, 25] + Y[25, 23] + Y[27, 14]  <=  -eps*V[0, 13]*t1[0, 6] + objc ]
	constraints += [ Y[2, 20] + Y[4, 18] + Y[5, 14] + Y[14, 5] + Y[18, 4] + Y[20, 2]  >=  -lamb*V[0, 0]*t0[0, 8] - 0.5*V[0, 3] - 0.5*V[0, 25] - objc ]
	constraints += [ Y[2, 20] + Y[4, 18] + Y[5, 14] + Y[14, 5] + Y[18, 4] + Y[20, 2]  <=  -lamb*V[0, 0]*t0[0, 8] - 0.5*V[0, 3] - 0.5*V[0, 25] + objc ]
	constraints += [ Y[14, 26] + Y[18, 25] + Y[20, 23] + Y[23, 20] + Y[25, 18] + Y[26, 14]  >=  -lamb*V[0, 21]*t0[0, 8] - V[0, 14]*t2[0, 13] - 1.0*V[0, 24] - objc ]
	constraints += [ Y[14, 26] + Y[18, 25] + Y[20, 23] + Y[23, 20] + Y[25, 18] + Y[26, 14]  <=  -lamb*V[0, 21]*t0[0, 8] - V[0, 14]*t2[0, 13] - 1.0*V[0, 24] + objc ]
	constraints += [ Y[14, 21] + Y[18, 20] + Y[20, 18] + Y[21, 14]  >=  -eps*V[0, 13]*t1[0, 5] - lamb*V[0, 16]*t0[0, 8] - 1.0*V[0, 19] - objc ]
	constraints += [ Y[14, 21] + Y[18, 20] + Y[20, 18] + Y[21, 14]  <=  -eps*V[0, 13]*t1[0, 5] - lamb*V[0, 16]*t0[0, 8] - 1.0*V[0, 19] + objc ]
	constraints += [ Y[2, 16] + Y[4, 14] + Y[14, 4] + Y[16, 2]  >=  -eps*V[0, 1]*t1[0, 2] - 0.5*V[0, 24] - objc ]
	constraints += [ Y[2, 16] + Y[4, 14] + Y[14, 4] + Y[16, 2]  <=  -eps*V[0, 1]*t1[0, 2] - 0.5*V[0, 24] + objc ]
	constraints += [ Y[14, 25] + Y[16, 23] + Y[23, 16] + Y[25, 14]  >=  -eps*V[0, 22]*t1[0, 2] - V[0, 10]*t2[0, 7] - objc ]
	constraints += [ Y[14, 25] + Y[16, 23] + Y[23, 16] + Y[25, 14]  <=  -eps*V[0, 22]*t1[0, 2] - V[0, 10]*t2[0, 7] + objc ]
	constraints += [ Y[14, 20] + Y[16, 18] + Y[18, 16] + Y[20, 14]  >=  -2*eps*V[0, 8]*t1[0, 4] - eps*V[0, 17]*t1[0, 2] - lamb*V[0, 12]*t0[0, 8] - 1.0*V[0, 15] - objc ]
	constraints += [ Y[14, 20] + Y[16, 18] + Y[18, 16] + Y[20, 14]  <=  -2*eps*V[0, 8]*t1[0, 4] - eps*V[0, 17]*t1[0, 2] - lamb*V[0, 12]*t0[0, 8] - 1.0*V[0, 15] + objc ]
	constraints += [ Y[14, 16] + Y[16, 14]  >=  -eps*V[0, 13]*t1[0, 2] - lamb*V[0, 7]*t0[0, 0] - objc ]
	constraints += [ Y[14, 16] + Y[16, 14]  <=  -eps*V[0, 13]*t1[0, 2] - lamb*V[0, 7]*t0[0, 0] + objc ]
	constraints += [ Y[0, 11] + Y[2, 3] + Y[3, 2] + Y[11, 0]  >=  -eps*V[0, 10]*t1[0, 11] - lamb*V[0, 0] - V[0, 10]*t2[0, 14] - 0.5*V[0, 18] - 0.5*V[0, 22] - objc ]
	constraints += [ Y[0, 11] + Y[2, 3] + Y[3, 2] + Y[11, 0]  <=  -eps*V[0, 10]*t1[0, 11] - lamb*V[0, 0] - V[0, 10]*t2[0, 14] - 0.5*V[0, 18] - 0.5*V[0, 22] + objc ]
	constraints += [ Y[2, 24] + Y[3, 23] + Y[6, 11] + Y[11, 6] + Y[23, 3] + Y[24, 2]  >=  -lamb*V[0, 21] + 0.5*V[0, 14] - objc ]
	constraints += [ Y[2, 24] + Y[3, 23] + Y[6, 11] + Y[11, 6] + Y[23, 3] + Y[24, 2]  <=  -lamb*V[0, 21] + 0.5*V[0, 14] + objc ]
	constraints += [ Y[11, 27] + Y[23, 24] + Y[24, 23] + Y[27, 11]  >=  -eps*V[0, 10]*t1[0, 6] - V[0, 10]*t2[0, 10] - 0.5*V[0, 22] - objc ]
	constraints += [ Y[11, 27] + Y[23, 24] + Y[24, 23] + Y[27, 11]  <=  -eps*V[0, 10]*t1[0, 6] - V[0, 10]*t2[0, 10] - 0.5*V[0, 22] + objc ]
	constraints += [ Y[2, 19] + Y[3, 18] + Y[5, 11] + Y[11, 5] + Y[18, 3] + Y[19, 2]  >=  -lamb*V[0, 16] - V[0, 2]*t2[0, 11] - 0.5*V[0, 13] - objc ]
	constraints += [ Y[2, 19] + Y[3, 18] + Y[5, 11] + Y[11, 5] + Y[18, 3] + Y[19, 2]  <=  -lamb*V[0, 16] - V[0, 2]*t2[0, 11] - 0.5*V[0, 13] + objc ]
	constraints += [ Y[11, 26] + Y[18, 24] + Y[19, 23] + Y[23, 19] + Y[24, 18] + Y[26, 11]  >=  -2*V[0, 11]*t2[0, 13] - 0.5*V[0, 17] - V[0, 23]*t2[0, 11] - 0.5*V[0, 23] - objc ]
	constraints += [ Y[11, 26] + Y[18, 24] + Y[19, 23] + Y[23, 19] + Y[24, 18] + Y[26, 11]  <=  -2*V[0, 11]*t2[0, 13] - 0.5*V[0, 17] - V[0, 23]*t2[0, 11] - 0.5*V[0, 23] + objc ]
	constraints += [ Y[11, 21] + Y[18, 19] + Y[19, 18] + Y[21, 11]  >=  -eps*V[0, 10]*t1[0, 5] - V[0, 10]*t2[0, 4] - V[0, 18]*t2[0, 11] - 0.5*V[0, 18] - objc ]
	constraints += [ Y[11, 21] + Y[18, 19] + Y[19, 18] + Y[21, 11]  <=  -eps*V[0, 10]*t1[0, 5] - V[0, 10]*t2[0, 4] - V[0, 18]*t2[0, 11] - 0.5*V[0, 18] + objc ]
	constraints += [ Y[2, 15] + Y[3, 14] + Y[4, 11] + Y[11, 4] + Y[14, 3] + Y[15, 2]  >=  -lamb*V[0, 12] + 0.5*V[0, 17] - 0.5*V[0, 23] - objc ]
	constraints += [ Y[2, 15] + Y[3, 14] + Y[4, 11] + Y[11, 4] + Y[14, 3] + Y[15, 2]  <=  -lamb*V[0, 12] + 0.5*V[0, 17] - 0.5*V[0, 23] + objc ]
	constraints += [ Y[11, 25] + Y[14, 24] + Y[15, 23] + Y[23, 15] + Y[24, 14] + Y[25, 11]  >=  -0.5*V[0, 13] - objc ]
	constraints += [ Y[11, 25] + Y[14, 24] + Y[15, 23] + Y[23, 15] + Y[24, 14] + Y[25, 11]  <=  -0.5*V[0, 13] + objc ]
	constraints += [ Y[11, 20] + Y[14, 19] + Y[15, 18] + Y[18, 15] + Y[19, 14] + Y[20, 11]  >=  -lamb*V[0, 9]*t0[0, 8] - V[0, 14]*t2[0, 11] - 0.5*V[0, 14] - objc ]
	constraints += [ Y[11, 20] + Y[14, 19] + Y[15, 18] + Y[18, 15] + Y[19, 14] + Y[20, 11]  <=  -lamb*V[0, 9]*t0[0, 8] - V[0, 14]*t2[0, 11] - 0.5*V[0, 14] + objc ]
	constraints += [ Y[11, 16] + Y[14, 15] + Y[15, 14] + Y[16, 11]  >=  -eps*V[0, 10]*t1[0, 2] - objc ]
	constraints += [ Y[11, 16] + Y[14, 15] + Y[15, 14] + Y[16, 11]  <=  -eps*V[0, 10]*t1[0, 2] + objc ]
	constraints += [ Y[2, 12] + Y[3, 11] + Y[11, 3] + Y[12, 2]  >=  -lamb*V[0, 9] - objc ]
	constraints += [ Y[2, 12] + Y[3, 11] + Y[11, 3] + Y[12, 2]  <=  -lamb*V[0, 9] + objc ]
	constraints += [ Y[11, 24] + Y[12, 23] + Y[23, 12] + Y[24, 11]  >=  -V[0, 10]*t2[0, 6] - objc ]
	constraints += [ Y[11, 24] + Y[12, 23] + Y[23, 12] + Y[24, 11]  <=  -V[0, 10]*t2[0, 6] + objc ]
	constraints += [ Y[11, 19] + Y[12, 18] + Y[18, 12] + Y[19, 11]  >=  -2*V[0, 11]*t2[0, 11] - objc ]
	...
	constraints += [ Y[11, 12] + Y[12, 11]  >=  -V[0, 10]*t2[0, 1] - objc ]
	constraints += [ Y[11, 12] + Y[12, 11]  <=  -V[0, 10]*t2[0, 1] + objc ]
	constraints += [ Y[0, 9] + Y[2, 2] + Y[9, 0]  >=  -2*eps*V[0, 8]*t1[0, 11] + n - 0.5*V[0, 17] - objc ]
	constraints += [ Y[0, 9] + Y[2, 2] + Y[9, 0]  <=  -2*eps*V[0, 8]*t1[0, 11] + n - 0.5*V[0, 17] + objc ]
	constraints += [ Y[2, 23] + Y[6, 9] + Y[9, 6] + Y[23, 2]  >=  -V[0, 2]*t2[0, 9] + 0.5*V[0, 13] - objc ]
	constraints += [ Y[2, 23] + Y[6, 9] + Y[9, 6] + Y[23, 2]  <=  -V[0, 2]*t2[0, 9] + 0.5*V[0, 13] + objc ]
	constraints += [ Y[9, 27] + Y[23, 23] + Y[27, 9]  >=  -2*eps*V[0, 8]*t1[0, 6] - V[0, 23]*t2[0, 9] - objc ]
	constraints += [ Y[9, 27] + Y[23, 23] + Y[27, 9]  <=  -2*eps*V[0, 8]*t1[0, 6] - V[0, 23]*t2[0, 9] + objc ]
	constraints += [ Y[2, 18] + Y[5, 9] + Y[9, 5] + Y[18, 2]  >=  -eps*V[0, 1]*t1[0, 3] - objc ]
	constraints += [ Y[2, 18] + Y[5, 9] + Y[9, 5] + Y[18, 2]  <=  -eps*V[0, 1]*t1[0, 3] + objc ]
	constraints += [ Y[9, 26] + Y[18, 23] + Y[23, 18] + Y[26, 9]  >=  -eps*V[0, 22]*t1[0, 3] - V[0, 10]*t2[0, 13] - V[0, 18]*t2[0, 9] - 0.5*V[0, 22] - objc ]
	constraints += [ Y[9, 26] + Y[18, 23] + Y[23, 18] + Y[26, 9]  <=  -eps*V[0, 22]*t1[0, 3] - V[0, 10]*t2[0, 13] - V[0, 18]*t2[0, 9] - 0.5*V[0, 22] + objc ]
	constraints += [ Y[9, 21] + Y[18, 18] + Y[21, 9]  >=  -2*eps*V[0, 8]*t1[0, 5] - eps*V[0, 17]*t1[0, 3] - 0.5*V[0, 17] - objc ]
	constraints += [ Y[9, 21] + Y[18, 18] + Y[21, 9]  <=  -2*eps*V[0, 8]*t1[0, 5] - eps*V[0, 17]*t1[0, 3] - 0.5*V[0, 17] + objc ]
	constraints += [ Y[2, 14] + Y[4, 9] + Y[9, 4] + Y[14, 2]  >=  -0.5*V[0, 22] - objc ]
	constraints += [ Y[2, 14] + Y[4, 9] + Y[9, 4] + Y[14, 2]  <=  -0.5*V[0, 22] + objc ]
	constraints += [ Y[9, 25] + Y[14, 23] + Y[23, 14] + Y[25, 9]  >=  -V[0, 14]*t2[0, 9] - objc ]
	constraints += [ Y[9, 25] + Y[14, 23] + Y[23, 14] + Y[25, 9]  <=  -V[0, 14]*t2[0, 9] + objc ]
	constraints += [ Y[9, 20] + Y[14, 18] + Y[18, 14] + Y[20, 9]  >=  -eps*V[0, 13]*t1[0, 3] - lamb*V[0, 7]*t0[0, 8] - 0.5*V[0, 13] - objc ]
	constraints += [ Y[9, 20] + Y[14, 18] + Y[18, 14] + Y[20, 9]  <=  -eps*V[0, 13]*t1[0, 3] - lamb*V[0, 7]*t0[0, 8] - 0.5*V[0, 13] + objc ]
	constraints += [ Y[9, 16] + Y[14, 14] + Y[16, 9]  >=  -2*eps*V[0, 8]*t1[0, 2] - objc ]
	constraints += [ Y[9, 16] + Y[14, 14] + Y[16, 9]  <=  -2*eps*V[0, 8]*t1[0, 2] + objc ]
	constraints += [ Y[2, 11] + Y[3, 9] + Y[9, 3] + Y[11, 2]  >=  -lamb*V[0, 7] - V[0, 2]*t2[0, 3] - objc ]
	constraints += [ Y[2, 11] + Y[3, 9] + Y[9, 3] + Y[11, 2]  <=  -lamb*V[0, 7] - V[0, 2]*t2[0, 3] + objc ]
	constraints += [ Y[9, 24] + Y[11, 23] + Y[23, 11] + Y[24, 9]  >=  -2*V[0, 11]*t2[0, 9] - V[0, 23]*t2[0, 3] - objc ]
	constraints += [ Y[9, 24] + Y[11, 23] + Y[23, 11] + Y[24, 9]  <=  -2*V[0, 11]*t2[0, 9] - V[0, 23]*t2[0, 3] + objc ]
	constraints += [ Y[9, 19] + Y[11, 18] + Y[18, 11] + Y[19, 9]  >=  -eps*V[0, 10]*t1[0, 3] - V[0, 10]*t2[0, 11] - V[0, 18]*t2[0, 3] - objc ]
	constraints += [ Y[9, 19] + Y[11, 18] + Y[18, 11] + Y[19, 9]  <=  -eps*V[0, 10]*t1[0, 3] - V[0, 10]*t2[0, 11] - V[0, 18]*t2[0, 3] + objc ]
	constraints += [ Y[9, 15] + Y[11, 14] + Y[14, 11] + Y[15, 9]  >=  -V[0, 14]*t2[0, 3] - objc ]
	constraints += [ Y[9, 15] + Y[11, 14] + Y[14, 11] + Y[15, 9]  <=  -V[0, 14]*t2[0, 3] + objc ]
	constraints += [ Y[9, 12] + Y[11, 11] + Y[12, 9]  >=  -2*V[0, 11]*t2[0, 3] - objc ]
	constraints += [ Y[9, 12] + Y[11, 11] + Y[12, 9]  <=  -2*V[0, 11]*t2[0, 3] + objc ]
	constraints += [ Y[2, 9] + Y[9, 2]  >=  -eps*V[0, 1]*t1[0, 1] - objc ]
	constraints += [ Y[2, 9] + Y[9, 2]  <=  -eps*V[0, 1]*t1[0, 1] + objc ]
	constraints += [ Y[9, 23] + Y[23, 9]  >=  -eps*V[0, 22]*t1[0, 1] - V[0, 10]*t2[0, 9] - objc ]
	constraints += [ Y[9, 23] + Y[23, 9]  <=  -eps*V[0, 22]*t1[0, 1] - V[0, 10]*t2[0, 9] + objc ]
	constraints += [ Y[9, 18] + Y[18, 9]  >=  -2*eps*V[0, 8]*t1[0, 3] - eps*V[0, 17]*t1[0, 1] - objc ]
	constraints += [ Y[9, 18] + Y[18, 9]  <=  -2*eps*V[0, 8]*t1[0, 3] - eps*V[0, 17]*t1[0, 1] + objc ]
	constraints += [ Y[9, 14] + Y[14, 9]  >=  -eps*V[0, 13]*t1[0, 1] - objc ]
	constraints += [ Y[9, 14] + Y[14, 9]  <=  -eps*V[0, 13]*t1[0, 1] + objc ]
	constraints += [ Y[9, 11] + Y[11, 9]  >=  -eps*V[0, 10]*t1[0, 1] - V[0, 10]*t2[0, 3] - objc ]
	constraints += [ Y[9, 11] + Y[11, 9]  <=  -eps*V[0, 10]*t1[0, 1] - V[0, 10]*t2[0, 3] + objc ]
	constraints += [ Y[9, 9]  >=  -2*eps*V[0, 8]*t1[0, 1] - objc ]
	constraints += [ Y[9, 9]  <=  -2*eps*V[0, 8]*t1[0, 1] + objc ]
	constraints += [ Y[0, 1] + Y[1, 0]  >=  -lamb*V[0, 0]*t0[0, 6] - 0.5*V[0, 3] - objc ]
	constraints += [ Y[0, 1] + Y[1, 0]  <=  -lamb*V[0, 0]*t0[0, 6] - 0.5*V[0, 3] + objc ]
	constraints += [ Y[0, 22] + Y[1, 6] + Y[6, 1] + Y[22, 0]  >=  -lamb*V[0, 21]*t0[0, 6] - 0.5*V[0, 4] - V[0, 9]*t2[0, 15] - 0.5*V[0, 24] - objc ]
	constraints += [ Y[0, 22] + Y[1, 6] + Y[6, 1] + Y[22, 0]  <=  -lamb*V[0, 21]*t0[0, 6] - 0.5*V[0, 4] - V[0, 9]*t2[0, 15] - 0.5*V[0, 24] + objc ]
	constraints += [ Y[1, 27] + Y[6, 22] + Y[22, 6] + Y[27, 1]  >=  -lamb*V[0, 0]*t0[0, 4] - 0.5*V[0, 25] - objc ]
	constraints += [ Y[1, 27] + Y[6, 22] + Y[22, 6] + Y[27, 1]  <=  -lamb*V[0, 0]*t0[0, 4] - 0.5*V[0, 25] + objc ]
	constraints += [ Y[22, 27] + Y[27, 22]  >=  -lamb*V[0, 21]*t0[0, 4] - V[0, 9]*t2[0, 0] - objc ]
	constraints += [ Y[22, 27] + Y[27, 22]  <=  -lamb*V[0, 21]*t0[0, 4] - V[0, 9]*t2[0, 0] + objc ]
	constraints += [ Y[0, 17] + Y[1, 5] + Y[5, 1] + Y[17, 0]  >=  -eps*V[0, 7]*t1[0, 10] - lamb*V[0, 16]*t0[0, 6] + 0.5*V[0, 5] - 0.5*V[0, 19] - objc ]
	constraints += [ Y[0, 17] + Y[1, 5] + Y[5, 1] + Y[17, 0]  <=  -eps*V[0, 7]*t1[0, 10] - lamb*V[0, 16]*t0[0, 6] + 0.5*V[0, 5] - 0.5*V[0, 19] + objc ]
	constraints += [ Y[1, 26] + Y[5, 22] + Y[6, 17] + Y[17, 6] + Y[22, 5] + Y[26, 1]  >=  -1.0*V[0, 20] + 1.0*V[0, 26] - objc ]
	constraints += [ Y[1, 26] + Y[5, 22] + Y[6, 17] + Y[17, 6] + Y[22, 5] + Y[26, 1]  <=  -1.0*V[0, 20] + 1.0*V[0, 26] + objc ]
	constraints += [ Y[17, 27] + Y[22, 26] + Y[26, 22] + Y[27, 17]  >=  -eps*V[0, 7]*t1[0, 7] - lamb*V[0, 16]*t0[0, 4] - objc ]
	constraints += [ Y[17, 27] + Y[22, 26] + Y[26, 22] + Y[27, 17]  <=  -eps*V[0, 7]*t1[0, 7] - lamb*V[0, 16]*t0[0, 4] + objc ]
	constraints += [ Y[1, 21] + Y[5, 17] + Y[17, 5] + Y[21, 1]  >=  -lamb*V[0, 0]*t0[0, 3] + 0.5*V[0, 25] - objc ]
	constraints += [ Y[1, 21] + Y[5, 17] + Y[17, 5] + Y[21, 1]  <=  -lamb*V[0, 0]*t0[0, 3] + 0.5*V[0, 25] + objc ]
	constraints += [ Y[17, 26] + Y[21, 22] + Y[22, 21] + Y[26, 17]  >=  -lamb*V[0, 21]*t0[0, 3] - V[0, 9]*t2[0, 8] - objc ]
	constraints += [ Y[17, 26] + Y[21, 22] + Y[22, 21] + Y[26, 17]  <=  -lamb*V[0, 21]*t0[0, 3] - V[0, 9]*t2[0, 8] + objc ]
	constraints += [ Y[17, 21] + Y[21, 17]  >=  -eps*V[0, 7]*t1[0, 0] - lamb*V[0, 16]*t0[0, 3] - objc ]
	constraints += [ Y[17, 21] + Y[21, 17]  <=  -eps*V[0, 7]*t1[0, 0] - lamb*V[0, 16]*t0[0, 3] + objc ]
	constraints += [ Y[0, 13] + Y[1, 4] + Y[4, 1] + Y[13, 0]  >=  -2*lamb*V[0, 6]*t0[0, 7] - lamb*V[0, 12]*t0[0, 6] - 1.0*V[0, 15] - objc ]
	constraints += [ Y[0, 13] + Y[1, 4] + Y[4, 1] + Y[13, 0]  <=  -2*lamb*V[0, 6]*t0[0, 7] - lamb*V[0, 12]*t0[0, 6] - 1.0*V[0, 15] + objc ]
	constraints += [ Y[1, 25] + Y[4, 22] + Y[6, 13] + Y[13, 6] + Y[22, 4] + Y[25, 1]  >=  -0.5*V[0, 5] - 0.5*V[0, 19] - objc ]
	constraints += [ Y[1, 25] + Y[4, 22] + Y[6, 13] + Y[13, 6] + Y[22, 4] + Y[25, 1]  <=  -0.5*V[0, 5] - 0.5*V[0, 19] + objc ]
	constraints += [ Y[13, 27] + Y[22, 25] + Y[25, 22] + Y[27, 13]  >=  -lamb*V[0, 12]*t0[0, 4] - 1.0*V[0, 26] - objc ]
	constraints += [ Y[13, 27] + Y[22, 25] + Y[25, 22] + Y[27, 13]  <=  -lamb*V[0, 12]*t0[0, 4] - 1.0*V[0, 26] + objc ]
	constraints += [ Y[1, 20] + Y[4, 17] + Y[5, 13] + Y[13, 5] + Y[17, 4] + Y[20, 1]  >=  -eps*V[0, 1]*t1[0, 9] - 0.5*V[0, 4] + 0.5*V[0, 24] - objc ]
	constraints += [ Y[1, 20] + Y[4, 17] + Y[5, 13] + Y[13, 5] + Y[17, 4] + Y[20, 1]  <=  -eps*V[0, 1]*t1[0, 9] - 0.5*V[0, 4] + 0.5*V[0, 24] + objc ]
	constraints += [ Y[13, 26] + Y[17, 25] + Y[20, 22] + Y[22, 20] + Y[25, 17] + Y[26, 13]  >=  -eps*V[0, 22]*t1[0, 9] - 1.0*V[0, 25] - objc ]
	constraints += [ Y[13, 26] + Y[17, 25] + Y[20, 22] + Y[22, 20] + Y[25, 17] + Y[26, 13]  <=  -eps*V[0, 22]*t1[0, 9] - 1.0*V[0, 25] + objc ]
	constraints += [ Y[13, 21] + Y[17, 20] + Y[20, 17] + Y[21, 13]  >=  -eps*V[0, 17]*t1[0, 9] - lamb*V[0, 12]*t0[0, 3] - 1.0*V[0, 20] - objc ]
	constraints += [ Y[13, 21] + Y[17, 20] + Y[20, 17] + Y[21, 13]  <=  -eps*V[0, 17]*t1[0, 9] - lamb*V[0, 12]*t0[0, 3] - 1.0*V[0, 20] + objc ]
	constraints += [ Y[1, 16] + Y[4, 13] + Y[13, 4] + Y[16, 1]  >=  -lamb*V[0, 0]*t0[0, 2] - 0.5*V[0, 3] - objc ]
	constraints += [ Y[1, 16] + Y[4, 13] + Y[13, 4] + Y[16, 1]  <=  -lamb*V[0, 0]*t0[0, 2] - 0.5*V[0, 3] + objc ]
	constraints += [ Y[13, 25] + Y[16, 22] + Y[22, 16] + Y[25, 13]  >=  -lamb*V[0, 21]*t0[0, 2] - V[0, 9]*t2[0, 7] - 1.0*V[0, 24] - objc ]
	constraints += [ Y[13, 25] + Y[16, 22] + Y[22, 16] + Y[25, 13]  <=  -lamb*V[0, 21]*t0[0, 2] - V[0, 9]*t2[0, 7] - 1.0*V[0, 24] + objc ]
	constraints += [ Y[13, 20] + Y[16, 17] + Y[17, 16] + Y[20, 13]  >=  -eps*V[0, 7]*t1[0, 4] - eps*V[0, 13]*t1[0, 9] - lamb*V[0, 16]*t0[0, 2] - 1.0*V[0, 19] - objc ]
	constraints += [ Y[13, 20] + Y[16, 17] + Y[17, 16] + Y[20, 13]  <=  -eps*V[0, 7]*t1[0, 4] - eps*V[0, 13]*t1[0, 9] - lamb*V[0, 16]*t0[0, 2] - 1.0*V[0, 19] + objc ]
	constraints += [ Y[13, 16] + Y[16, 13]  >=  -2*lamb*V[0, 6]*t0[0, 0] - lamb*V[0, 12]*t0[0, 2] - 1.0*V[0, 15] - objc ]
	constraints += [ Y[13, 16] + Y[16, 13]  <=  -2*lamb*V[0, 6]*t0[0, 0] - lamb*V[0, 12]*t0[0, 2] - 1.0*V[0, 15] + objc ]
	constraints += [ Y[0, 10] + Y[1, 3] + Y[3, 1] + Y[10, 0]  >=  3*eps*V[0, 1] - lamb*V[0, 9]*t0[0, 6] - V[0, 9]*t2[0, 14] - 0.5*V[0, 14] - 0.5*V[0, 21] - objc ]
	constraints += [ Y[0, 10] + Y[1, 3] + Y[3, 1] + Y[10, 0]  <=  3*eps*V[0, 1] - lamb*V[0, 9]*t0[0, 6] - V[0, 9]*t2[0, 14] - 0.5*V[0, 14] - 0.5*V[0, 21] + objc ]
	constraints += [ Y[1, 24] + Y[3, 22] + Y[6, 10] + Y[10, 6] + Y[22, 3] + Y[24, 1]  >=  3*eps*V[0, 22] - 0.5*V[0, 18] - objc ]
	constraints += [ Y[1, 24] + Y[3, 22] + Y[6, 10] + Y[10, 6] + Y[22, 3] + Y[24, 1]  <=  3*eps*V[0, 22] - 0.5*V[0, 18] + objc ]
	constraints += [ Y[10, 27] + Y[22, 24] + Y[24, 22] + Y[27, 10]  >=  -lamb*V[0, 9]*t0[0, 4] - V[0, 9]*t2[0, 10] - 0.5*V[0, 21] - objc ]
	constraints += [ Y[10, 27] + Y[22, 24] + Y[24, 22] + Y[27, 10]  <=  -lamb*V[0, 9]*t0[0, 4] - V[0, 9]*t2[0, 10] - 0.5*V[0, 21] + objc ]
	constraints += [ Y[1, 19] + Y[3, 17] + Y[5, 10] + Y[10, 5] + Y[17, 3] + Y[19, 1]  >=  3*eps*V[0, 17] - 0.5*V[0, 12] + 0.5*V[0, 23] - objc ]
	constraints += [ Y[1, 19] + Y[3, 17] + Y[5, 10] + Y[10, 5] + Y[17, 3] + Y[19, 1]  <=  3*eps*V[0, 17] - 0.5*V[0, 12] + 0.5*V[0, 23] + objc ]
	constraints += [ Y[10, 26] + Y[17, 24] + Y[19, 22] + Y[22, 19] + Y[24, 17] + Y[26, 10]  >=  -0.5*V[0, 16] - objc ]
	constraints += [ Y[10, 26] + Y[17, 24] + Y[19, 22] + Y[22, 19] + Y[24, 17] + Y[26, 10]  <=  -0.5*V[0, 16] + objc ]
	constraints += [ Y[10, 21] + Y[17, 19] + Y[19, 17] + Y[21, 10]  >=  -lamb*V[0, 9]*t0[0, 3] - V[0, 9]*t2[0, 4] - objc ]
	constraints += [ Y[10, 21] + Y[17, 19] + Y[19, 17] + Y[21, 10]  <=  -lamb*V[0, 9]*t0[0, 3] - V[0, 9]*t2[0, 4] + objc ]
	constraints += [ Y[1, 15] + Y[3, 13] + Y[4, 10] + Y[10, 4] + Y[13, 3] + Y[15, 1]  >=  3*eps*V[0, 13] - V[0, 2]*t2[0, 12] + 0.5*V[0, 16] - objc ]
	constraints += [ Y[1, 15] + Y[3, 13] + Y[4, 10] + Y[10, 4] + Y[13, 3] + Y[15, 1]  <=  3*eps*V[0, 13] - V[0, 2]*t2[0, 12] + 0.5*V[0, 16] + objc ]
	constraints += [ Y[10, 25] + Y[13, 24] + Y[15, 22] + Y[22, 15] + Y[24, 13] + Y[25, 10]  >=  -0.5*V[0, 12] - V[0, 23]*t2[0, 12] - 0.5*V[0, 23] - objc ]
	constraints += [ Y[10, 25] + Y[13, 24] + Y[15, 22] + Y[22, 15] + Y[24, 13] + Y[25, 10]  <=  -0.5*V[0, 12] - V[0, 23]*t2[0, 12] - 0.5*V[0, 23] + objc ]
	constraints += [ Y[10, 20] + Y[13, 19] + Y[15, 17] + Y[17, 15] + Y[19, 13] + Y[20, 10]  >=  -eps*V[0, 10]*t1[0, 9] - V[0, 18]*t2[0, 12] - 0.5*V[0, 18] - objc ]
	constraints += [ Y[10, 20] + Y[13, 19] + Y[15, 17] + Y[17, 15] + Y[19, 13] + Y[20, 10]  <=  -eps*V[0, 10]*t1[0, 9] - V[0, 18]*t2[0, 12] - 0.5*V[0, 18] + objc ]
	constraints += [ Y[10, 16] + Y[13, 15] + Y[15, 13] + Y[16, 10]  >=  -lamb*V[0, 9]*t0[0, 2] - V[0, 14]*t2[0, 12] - 0.5*V[0, 14] - objc ]
	constraints += [ Y[10, 16] + Y[13, 15] + Y[15, 13] + Y[16, 10]  <=  -lamb*V[0, 9]*t0[0, 2] - V[0, 14]*t2[0, 12] - 0.5*V[0, 14] + objc ]
	constraints += [ Y[1, 12] + Y[3, 10] + Y[10, 3] + Y[12, 1]  >=  3*eps*V[0, 10] - objc ]
	constraints += [ Y[1, 12] + Y[3, 10] + Y[10, 3] + Y[12, 1]  <=  3*eps*V[0, 10] + objc ]
	constraints += [ Y[10, 24] + Y[12, 22] + Y[22, 12] + Y[24, 10]  >=  -V[0, 9]*t2[0, 6] - objc ]
	constraints += [ Y[10, 24] + Y[12, 22] + Y[22, 12] + Y[24, 10]  <=  -V[0, 9]*t2[0, 6] + objc ]
	constraints += [ Y[10, 19] + Y[12, 17] + Y[17, 12] + Y[19, 10]  ==  0 ]
	...
	constraints += [ Y[10, 12] + Y[12, 10]  >=  -V[0, 9]*t2[0, 1] - objc ]
	constraints += [ Y[10, 12] + Y[12, 10]  <=  -V[0, 9]*t2[0, 1] + objc ]
	constraints += [ Y[0, 8] + Y[1, 2] + Y[2, 1] + Y[8, 0]  >=  -eps*V[0, 7]*t1[0, 11] - lamb*V[0, 7]*t0[0, 6] - 2*V[0, 2] - 0.5*V[0, 13] - 0.5*V[0, 16] - objc ]
	constraints += [ Y[0, 8] + Y[1, 2] + Y[2, 1] + Y[8, 0]  <=  -eps*V[0, 7]*t1[0, 11] - lamb*V[0, 7]*t0[0, 6] - 2*V[0, 2] - 0.5*V[0, 13] - 0.5*V[0, 16] + objc ]
	constraints += [ Y[1, 23] + Y[2, 22] + Y[6, 8] + Y[8, 6] + Y[22, 2] + Y[23, 1]  >=  0.5*V[0, 12] - 0.5*V[0, 17] - 2*V[0, 23] - objc ]
	constraints += [ Y[1, 23] + Y[2, 22] + Y[6, 8] + Y[8, 6] + Y[22, 2] + Y[23, 1]  <=  0.5*V[0, 12] - 0.5*V[0, 17] - 2*V[0, 23] + objc ]
	constraints += [ Y[8, 27] + Y[22, 23] + Y[23, 22] + Y[27, 8]  >=  -eps*V[0, 7]*t1[0, 6] - lamb*V[0, 7]*t0[0, 4] - objc ]
	constraints += [ Y[8, 27] + Y[22, 23] + Y[23, 22] + Y[27, 8]  <=  -eps*V[0, 7]*t1[0, 6] - lamb*V[0, 7]*t0[0, 4] + objc ]
	constraints += [ Y[1, 18] + Y[2, 17] + Y[5, 8] + Y[8, 5] + Y[17, 2] + Y[18, 1]  >=  -2*V[0, 18] + 0.5*V[0, 22] - objc ]
	constraints += [ Y[1, 18] + Y[2, 17] + Y[5, 8] + Y[8, 5] + Y[17, 2] + Y[18, 1]  <=  -2*V[0, 18] + 0.5*V[0, 22] + objc ]
	constraints += [ Y[8, 26] + Y[17, 23] + Y[18, 22] + Y[22, 18] + Y[23, 17] + Y[26, 8]  >=  -V[0, 9]*t2[0, 13] - 0.5*V[0, 21] - objc ]
	constraints += [ Y[8, 26] + Y[17, 23] + Y[18, 22] + Y[22, 18] + Y[23, 17] + Y[26, 8]  <=  -V[0, 9]*t2[0, 13] - 0.5*V[0, 21] + objc ]
	constraints += [ Y[8, 21] + Y[17, 18] + Y[18, 17] + Y[21, 8]  >=  -eps*V[0, 7]*t1[0, 5] - lamb*V[0, 7]*t0[0, 3] - 0.5*V[0, 16] - objc ]
	constraints += [ Y[8, 21] + Y[17, 18] + Y[18, 17] + Y[21, 8]  <=  -eps*V[0, 7]*t1[0, 5] - lamb*V[0, 7]*t0[0, 3] - 0.5*V[0, 16] + objc ]
	constraints += [ Y[1, 14] + Y[2, 13] + Y[4, 8] + Y[8, 4] + Y[13, 2] + Y[14, 1]  >=  -eps*V[0, 1]*t1[0, 12] - 2*V[0, 14] - 0.5*V[0, 21] - objc ]
	constraints += [ Y[1, 14] + Y[2, 13] + Y[4, 8] + Y[8, 4] + Y[13, 2] + Y[14, 1]  <=  -eps*V[0, 1]*t1[0, 12] - 2*V[0, 14] - 0.5*V[0, 21] + objc ]
	constraints += [ Y[8, 25] + Y[13, 23] + Y[14, 22] + Y[22, 14] + Y[23, 13] + Y[25, 8]  >=  -eps*V[0, 22]*t1[0, 12] - 0.5*V[0, 22] - objc ]
	constraints += [ Y[8, 25] + Y[13, 23] + Y[14, 22] + Y[22, 14] + Y[23, 13] + Y[25, 8]  <=  -eps*V[0, 22]*t1[0, 12] - 0.5*V[0, 22] + objc ]
	constraints += [ Y[8, 20] + Y[13, 18] + Y[14, 17] + Y[17, 14] + Y[18, 13] + Y[20, 8]  >=  -2*eps*V[0, 8]*t1[0, 9] - eps*V[0, 17]*t1[0, 12] - 2*lamb*V[0, 6]*t0[0, 8] - 0.5*V[0, 12] - 0.5*V[0, 17] - objc ]
	constraints += [ Y[8, 20] + Y[13, 18] + Y[14, 17] + Y[17, 14] + Y[18, 13] + Y[20, 8]  <=  -2*eps*V[0, 8]*t1[0, 9] - eps*V[0, 17]*t1[0, 12] - 2*lamb*V[0, 6]*t0[0, 8] - 0.5*V[0, 12] - 0.5*V[0, 17] + objc ]
	constraints += [ Y[8, 16] + Y[13, 14] + Y[14, 13] + Y[16, 8]  >=  -eps*V[0, 7]*t1[0, 2] - eps*V[0, 13]*t1[0, 12] - lamb*V[0, 7]*t0[0, 2] - 0.5*V[0, 13] - objc ]
	constraints += [ Y[8, 16] + Y[13, 14] + Y[14, 13] + Y[16, 8]  <=  -eps*V[0, 7]*t1[0, 2] - eps*V[0, 13]*t1[0, 12] - lamb*V[0, 7]*t0[0, 2] - 0.5*V[0, 13] + objc ]
	constraints += [ Y[1, 11] + Y[2, 10] + Y[3, 8] + Y[8, 3] + Y[10, 2] + Y[11, 1]  >=  6*eps*V[0, 8] - 2*lamb*V[0, 6] - 4*V[0, 11] - objc ]
	constraints += [ Y[1, 11] + Y[2, 10] + Y[3, 8] + Y[8, 3] + Y[10, 2] + Y[11, 1]  <=  6*eps*V[0, 8] - 2*lamb*V[0, 6] - 4*V[0, 11] + objc ]
	constraints += [ Y[8, 24] + Y[10, 23] + Y[11, 22] + Y[22, 11] + Y[23, 10] + Y[24, 8]  ==  0 ]
	constraints += [ Y[8, 19] + Y[10, 18] + Y[11, 17] + Y[17, 11] + Y[18, 10] + Y[19, 8]  >=  -V[0, 9]*t2[0, 11] - objc ]
	constraints += [ Y[8, 19] + Y[10, 18] + Y[11, 17] + Y[17, 11] + Y[18, 10] + Y[19, 8]  <=  -V[0, 9]*t2[0, 11] + objc ]
	constraints += [ Y[8, 15] + Y[10, 14] + Y[11, 13] + Y[13, 11] + Y[14, 10] + Y[15, 8]  >=  -eps*V[0, 10]*t1[0, 12] - V[0, 10]*t2[0, 12] - objc ]
	constraints += [ Y[8, 15] + Y[10, 14] + Y[11, 13] + Y[13, 11] + Y[14, 10] + Y[15, 8]  <=  -eps*V[0, 10]*t1[0, 12] - V[0, 10]*t2[0, 12] + objc ]
	constraints += [ Y[8, 12] + Y[10, 11] + Y[11, 10] + Y[12, 8]  ==  0 ]
	constraints += [ Y[1, 9] + Y[2, 8] + Y[8, 2] + Y[9, 1]  >=  -2*V[0, 10] - objc ]
	constraints += [ Y[1, 9] + Y[2, 8] + Y[8, 2] + Y[9, 1]  <=  -2*V[0, 10] + objc ]
	constraints += [ Y[8, 23] + Y[9, 22] + Y[22, 9] + Y[23, 8]  >=  -V[0, 9]*t2[0, 9] - objc ]
	constraints += [ Y[8, 23] + Y[9, 22] + Y[22, 9] + Y[23, 8]  <=  -V[0, 9]*t2[0, 9] + objc ]
	constraints += [ Y[8, 18] + Y[9, 17] + Y[17, 9] + Y[18, 8]  >=  -eps*V[0, 7]*t1[0, 3] - objc ]
	constraints += [ Y[8, 18] + Y[9, 17] + Y[17, 9] + Y[18, 8]  <=  -eps*V[0, 7]*t1[0, 3] + objc ]
	constraints += [ Y[8, 14] + Y[9, 13] + Y[13, 9] + Y[14, 8]  >=  -2*eps*V[0, 8]*t1[0, 12] - objc ]
	constraints += [ Y[8, 14] + Y[9, 13] + Y[13, 9] + Y[14, 8]  <=  -2*eps*V[0, 8]*t1[0, 12] + objc ]
	constraints += [ Y[8, 11] + Y[9, 10] + Y[10, 9] + Y[11, 8]  >=  -V[0, 9]*t2[0, 3] - objc ]
	constraints += [ Y[8, 11] + Y[9, 10] + Y[10, 9] + Y[11, 8]  <=  -V[0, 9]*t2[0, 3] + objc ]
	constraints += [ Y[8, 9] + Y[9, 8]  >=  -eps*V[0, 7]*t1[0, 1] - objc ]
	constraints += [ Y[8, 9] + Y[9, 8]  <=  -eps*V[0, 7]*t1[0, 1] + objc ]
	constraints += [ Y[0, 7] + Y[1, 1] + Y[7, 0]  >=  -2*lamb*V[0, 6]*t0[0, 6] + n - 0.5*V[0, 12] - objc ]
	constraints += [ Y[0, 7] + Y[1, 1] + Y[7, 0]  <=  -2*lamb*V[0, 6]*t0[0, 6] + n - 0.5*V[0, 12] + objc ]
	constraints += [ Y[1, 22] + Y[6, 7] + Y[7, 6] + Y[22, 1]  >=  -V[0, 2]*t2[0, 5] - 0.5*V[0, 16] - objc ]
	constraints += [ Y[1, 22] + Y[6, 7] + Y[7, 6] + Y[22, 1]  <=  -V[0, 2]*t2[0, 5] - 0.5*V[0, 16] + objc ]
	constraints += [ Y[7, 27] + Y[22, 22] + Y[27, 7]  >=  -2*lamb*V[0, 6]*t0[0, 4] - V[0, 23]*t2[0, 5] - objc ]
	constraints += [ Y[7, 27] + Y[22, 22] + Y[27, 7]  <=  -2*lamb*V[0, 6]*t0[0, 4] - V[0, 23]*t2[0, 5] + objc ]
	constraints += [ Y[1, 17] + Y[5, 7] + Y[7, 5] + Y[17, 1]  >=  0.5*V[0, 21] - objc ]
	constraints += [ Y[1, 17] + Y[5, 7] + Y[7, 5] + Y[17, 1]  <=  0.5*V[0, 21] + objc ]
	constraints += [ Y[7, 26] + Y[17, 22] + Y[22, 17] + Y[26, 7]  >=  -V[0, 18]*t2[0, 5] - objc ]
	constraints += [ Y[7, 26] + Y[17, 22] + Y[22, 17] + Y[26, 7]  <=  -V[0, 18]*t2[0, 5] + objc ]
	constraints += [ Y[7, 21] + Y[17, 17] + Y[21, 7]  >=  -2*lamb*V[0, 6]*t0[0, 3] - objc ]
	constraints += [ Y[7, 21] + Y[17, 17] + Y[21, 7]  <=  -2*lamb*V[0, 6]*t0[0, 3] + objc ]
	constraints += [ Y[1, 13] + Y[4, 7] + Y[7, 4] + Y[13, 1]  >=  -lamb*V[0, 0]*t0[0, 5] - objc ]
	constraints += [ Y[1, 13] + Y[4, 7] + Y[7, 4] + Y[13, 1]  <=  -lamb*V[0, 0]*t0[0, 5] + objc ]
	constraints += [ Y[7, 25] + Y[13, 22] + Y[22, 13] + Y[25, 7]  >=  -lamb*V[0, 21]*t0[0, 5] - V[0, 14]*t2[0, 5] - 0.5*V[0, 21] - objc ]
	constraints += [ Y[7, 25] + Y[13, 22] + Y[22, 13] + Y[25, 7]  <=  -lamb*V[0, 21]*t0[0, 5] - V[0, 14]*t2[0, 5] - 0.5*V[0, 21] + objc ]
	constraints += [ Y[7, 20] + Y[13, 17] + Y[17, 13] + Y[20, 7]  >=  -eps*V[0, 7]*t1[0, 9] - lamb*V[0, 16]*t0[0, 5] - 0.5*V[0, 16] - objc ]
	constraints += [ Y[7, 20] + Y[13, 17] + Y[17, 13] + Y[20, 7]  <=  -eps*V[0, 7]*t1[0, 9] - lamb*V[0, 16]*t0[0, 5] - 0.5*V[0, 16] + objc ]
	constraints += [ Y[7, 16] + Y[13, 13] + Y[16, 7]  >=  -2*lamb*V[0, 6]*t0[0, 2] - lamb*V[0, 12]*t0[0, 5] - 0.5*V[0, 12] - objc ]
	constraints += [ Y[7, 16] + Y[13, 13] + Y[16, 7]  <=  -2*lamb*V[0, 6]*t0[0, 2] - lamb*V[0, 12]*t0[0, 5] - 0.5*V[0, 12] + objc ]
	constraints += [ Y[1, 10] + Y[3, 7] + Y[7, 3] + Y[10, 1]  >=  3*eps*V[0, 7] - V[0, 2]*t2[0, 2] - objc ]
	constraints += [ Y[1, 10] + Y[3, 7] + Y[7, 3] + Y[10, 1]  <=  3*eps*V[0, 7] - V[0, 2]*t2[0, 2] + objc ]
	constraints += [ Y[7, 24] + Y[10, 22] + Y[22, 10] + Y[24, 7]  >=  -2*V[0, 11]*t2[0, 5] - V[0, 23]*t2[0, 2] - objc ]
	constraints += [ Y[7, 24] + Y[10, 22] + Y[22, 10] + Y[24, 7]  <=  -2*V[0, 11]*t2[0, 5] - V[0, 23]*t2[0, 2] + objc ]
	constraints += [ Y[7, 19] + Y[10, 17] + Y[17, 10] + Y[19, 7]  >=  -V[0, 18]*t2[0, 2] - objc ]
	constraints += [ Y[7, 19] + Y[10, 17] + Y[17, 10] + Y[19, 7]  <=  -V[0, 18]*t2[0, 2] + objc ]
	constraints += [ Y[7, 15] + Y[10, 13] + Y[13, 10] + Y[15, 7]  >=  -lamb*V[0, 9]*t0[0, 5] - V[0, 9]*t2[0, 12] - V[0, 14]*t2[0, 2] - objc ]
	constraints += [ Y[7, 15] + Y[10, 13] + Y[13, 10] + Y[15, 7]  <=  -lamb*V[0, 9]*t0[0, 5] - V[0, 9]*t2[0, 12] - V[0, 14]*t2[0, 2] + objc ]
	constraints += [ Y[7, 12] + Y[10, 10] + Y[12, 7]  >=  -2*V[0, 11]*t2[0, 2] - objc ]
	constraints += [ Y[7, 12] + Y[10, 10] + Y[12, 7]  <=  -2*V[0, 11]*t2[0, 2] + objc ]
	constraints += [ Y[1, 8] + Y[2, 7] + Y[7, 2] + Y[8, 1]  >=  -eps*V[0, 1]*t1[0, 8] - 2*V[0, 9] - objc ]
	constraints += [ Y[1, 8] + Y[2, 7] + Y[7, 2] + Y[8, 1]  <=  -eps*V[0, 1]*t1[0, 8] - 2*V[0, 9] + objc ]
	constraints += [ Y[7, 23] + Y[8, 22] + Y[22, 8] + Y[23, 7]  >=  -eps*V[0, 22]*t1[0, 8] - V[0, 10]*t2[0, 5] - objc ]
	constraints += [ Y[7, 23] + Y[8, 22] + Y[22, 8] + Y[23, 7]  <=  -eps*V[0, 22]*t1[0, 8] - V[0, 10]*t2[0, 5] + objc ]
	constraints += [ Y[7, 18] + Y[8, 17] + Y[17, 8] + Y[18, 7]  >=  -eps*V[0, 17]*t1[0, 8] - objc ]
	constraints += [ Y[7, 18] + Y[8, 17] + Y[17, 8] + Y[18, 7]  <=  -eps*V[0, 17]*t1[0, 8] + objc ]
	constraints += [ Y[7, 14] + Y[8, 13] + Y[13, 8] + Y[14, 7]  >=  -eps*V[0, 7]*t1[0, 12] - eps*V[0, 13]*t1[0, 8] - lamb*V[0, 7]*t0[0, 5] - objc ]
	constraints += [ Y[7, 14] + Y[8, 13] + Y[13, 8] + Y[14, 7]  <=  -eps*V[0, 7]*t1[0, 12] - eps*V[0, 13]*t1[0, 8] - lamb*V[0, 7]*t0[0, 5] + objc ]
	constraints += [ Y[7, 11] + Y[8, 10] + Y[10, 8] + Y[11, 7]  >=  -eps*V[0, 10]*t1[0, 8] - V[0, 10]*t2[0, 2] - objc ]
	constraints += [ Y[7, 11] + Y[8, 10] + Y[10, 8] + Y[11, 7]  <=  -eps*V[0, 10]*t1[0, 8] - V[0, 10]*t2[0, 2] + objc ]
	constraints += [ Y[7, 9] + Y[8, 8] + Y[9, 7]  >=  -2*eps*V[0, 8]*t1[0, 8] - objc ]
	constraints += [ Y[7, 9] + Y[8, 8] + Y[9, 7]  <=  -2*eps*V[0, 8]*t1[0, 8] + objc ]
	constraints += [ Y[1, 7] + Y[7, 1]  >=  -lamb*V[0, 0]*t0[0, 1] - objc ]
	constraints += [ Y[1, 7] + Y[7, 1]  <=  -lamb*V[0, 0]*t0[0, 1] + objc ]
	constraints += [ Y[7, 22] + Y[22, 7]  >=  -lamb*V[0, 21]*t0[0, 1] - V[0, 9]*t2[0, 5] - objc ]
	constraints += [ Y[7, 22] + Y[22, 7]  <=  -lamb*V[0, 21]*t0[0, 1] - V[0, 9]*t2[0, 5] + objc ]
	constraints += [ Y[7, 17] + Y[17, 7]  >=  -lamb*V[0, 16]*t0[0, 1] - objc ]
	constraints += [ Y[7, 17] + Y[17, 7]  <=  -lamb*V[0, 16]*t0[0, 1] + objc ]
	constraints += [ Y[7, 13] + Y[13, 7]  >=  -2*lamb*V[0, 6]*t0[0, 5] - lamb*V[0, 12]*t0[0, 1] - objc ]
	constraints += [ Y[7, 13] + Y[13, 7]  <=  -2*lamb*V[0, 6]*t0[0, 5] - lamb*V[0, 12]*t0[0, 1] + objc ]
	constraints += [ Y[7, 10] + Y[10, 7]  >=  -lamb*V[0, 9]*t0[0, 1] - V[0, 9]*t2[0, 2] - objc ]
	constraints += [ Y[7, 10] + Y[10, 7]  <=  -lamb*V[0, 9]*t0[0, 1] - V[0, 9]*t2[0, 2] + objc ]
	constraints += [ Y[7, 8] + Y[8, 7]  >=  -eps*V[0, 7]*t1[0, 8] - lamb*V[0, 7]*t0[0, 1] - objc ]
	constraints += [ Y[7, 8] + Y[8, 7]  <=  -eps*V[0, 7]*t1[0, 8] - lamb*V[0, 7]*t0[0, 1] + objc ]
	constraints += [ Y[7, 7]  >=  -2*lamb*V[0, 6]*t0[0, 1] - objc ]
	constraints += [ Y[7, 7]  <=  -2*lamb*V[0, 6]*t0[0, 1] + objc ]
