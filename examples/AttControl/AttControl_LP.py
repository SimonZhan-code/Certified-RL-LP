...
def LyaTest(V, c0, c1, c2, m, n):
	...
	for j in range(10000):
		...
		if value < 0:
			valueTest = False
		V = np.reshape(V, (1, 28))
		Lie = 0.5*a**4*V[0, 12]*t0[0, 1] + 0.25*a**3*b*V[0, 27]*t0[0, 1] + 0.5*a**3*b*V[0, 27]*t1[0, 8] 
		+ 0.25*a**3*c*V[0, 26]*t0[0, 1] + a**3*c*V[0, 26]*t2[0, 2] + 0.5*a**3*d*V[0, 12]*t0[0, 5] 
		+ 0.25*a**3*d*V[0, 25]*t0[0, 1] + 0.25*a**3*e*V[0, 24]*t0[0, 1] + 0.25*a**3*f*V[0, 23]*t0[0, 1] 
		+ a**3*f*V[0, 26]*t2[0, 5] + 0.25*a**3*V[0, 6]*t0[0, 1] + 1.0*a**2*b**2*V[0, 11]*t1[0, 8] 
		+ 0.5*a**2*b*c*V[0, 22]*t1[0, 8] + a**2*b*c*V[0, 22]*t2[0, 2] + 0.5*a**2*b*d*V[0, 21]*t1[0, 8] 
		+ 0.25*a**2*b*d*V[0, 27]*t0[0, 5] + 0.5*a**2*b*d*V[0, 27]*t1[0, 12] + 0.5*a**2*b*e*V[0, 20]*t1[0, 8] 
		+ 0.5*a**2*b*f*V[0, 19]*t1[0, 8] + a**2*b*f*V[0, 22]*t2[0, 5] + 0.5*a**2*b*V[0, 5]*t1[0, 8] + 2*a**2*b*V[0, 26] 
		+ 2*a**2*c**2*V[0, 10]*t2[0, 2] + a**2*c*d*V[0, 18]*t2[0, 2] + 0.25*a**2*c*d*V[0, 26]*t0[0, 5] 
		+ a**2*c*d*V[0, 26]*t2[0, 12] + a**2*c*e*V[0, 17]*t2[0, 2] + 2*a**2*c*f*V[0, 10]*t2[0, 5] 
		+ a**2*c*f*V[0, 16]*t2[0, 2] + a**2*c*V[0, 4]*t2[0, 2] - 1.5*a**2*c*V[0, 27] + 0.5*a**2*d**2*V[0, 12]*t0[0, 2] 
		+ 0.25*a**2*d**2*V[0, 25]*t0[0, 5] + 0.5*a**2*d**2*V[0, 25] + 0.25*a**2*d*e*V[0, 24]*t0[0, 5]
		+ 0.5*a**2*d*e*V[0, 24] + 0.5*a**2*d*e*V[0, 27]*t1[0, 9] + a**2*d*f*V[0, 18]*t2[0, 5] 
		+ 0.25*a**2*d*f*V[0, 23]*t0[0, 5] + 0.5*a**2*d*f*V[0, 23] + 0.25*a**2*d*V[0, 6]*t0[0, 5] 
		+ 0.5*a**2*e**2*V[0, 12]*t0[0, 3] + a**2*e*f*V[0, 17]*t2[0, 5] - 0.5*a**2*e*V[0, 23] + 0.5*a**2*f**2*V[0, 12]*t0[0, 4] 
		+ a**2*f**2*V[0, 16]*t2[0, 5] + a**2*f*V[0, 4]*t2[0, 5] + 0.5*a**2*f*V[0, 24] + 0.5*a**2*V[0, 12]*t0[0, 6] 
		+ 0.5*a**2*V[0, 25] + 0.5*a*b**3*V[0, 27]*t1[0, 1] + a*b**2*c*V[0, 26]*t2[0, 3] + 1.0*a*b**2*d*V[0, 11]*t1[0, 12] 
		+ 0.5*a*b**2*e*V[0, 27]*t1[0, 3] + a*b**2*f*V[0, 26]*t2[0, 9] + 2*a*b**2*V[0, 22] + 0.5*a*b*c*d*V[0, 22]*t1[0, 12] 
		+ a*b*c*d*V[0, 22]*t2[0, 12] + a*b*c*e*V[0, 26]*t2[0, 11] + 4*a*b*c*V[0, 10] - 3.0*a*b*c*V[0, 11] 
		+ 0.5*a*b*c*V[0, 12] + 0.5*a*b*d**2*V[0, 21]*t1[0, 12] + 0.5*a*b*d**2*V[0, 21] + 0.25*a*b*d**2*V[0, 27]*t0[0, 2] 
		+ 0.5*a*b*d**2*V[0, 27]*t1[0, 2] + 1.0*a*b*d*e*V[0, 11]*t1[0, 9] + 0.5*a*b*d*e*V[0, 12]*t0[0, 8] 
		+ 0.5*a*b*d*e*V[0, 20]*t1[0, 12] + 0.5*a*b*d*e*V[0, 20] + 0.5*a*b*d*e*V[0, 25] + 0.5*a*b*d*f*V[0, 19]*t1[0, 12] 
		+ 0.5*a*b*d*f*V[0, 19] + 0.5*a*b*d*V[0, 5]*t1[0, 12] + 2*a*b*d*V[0, 18] + 0.5*a*b*d*V[0, 23] 
		+ 0.5*a*b*e**2*V[0, 24] + 0.25*a*b*e**2*V[0, 27]*t0[0, 3] + 0.5*a*b*e**2*V[0, 27]*t1[0, 5] + 0.5*a*b*e*f*V[0, 23] 
		+ a*b*e*f*V[0, 26]*t2[0, 13] + 2*a*b*e*V[0, 17] - 0.5*a*b*e*V[0, 19] + 0.25*a*b*f**2*V[0, 27]*t0[0, 4] 
		+ 0.5*a*b*f**2*V[0, 27]*t1[0, 6] + 2*a*b*f*V[0, 16] + 0.5*a*b*f*V[0, 20] - 0.5*a*b*f*V[0, 25] + 2*a*b*V[0, 4] 
		+ 0.5*a*b*V[0, 21] + 0.5*a*b*V[0, 24] + 0.25*a*b*V[0, 27]*t0[0, 6] + 0.5*a*b*V[0, 27]*t1[0, 11] 
		+ a*c**3*V[0, 26]*t2[0, 1] + 2*a*c**2*d*V[0, 10]*t2[0, 12] + a*c**2*f*V[0, 26]*t2[0, 6] - 1.5*a*c**2*V[0, 22] 
		+ a*c*d**2*V[0, 18]*t2[0, 12] + 0.5*a*c*d**2*V[0, 18] + 0.25*a*c*d**2*V[0, 26]*t0[0, 2] + a*c*d*e*V[0, 17]*t2[0, 12] 
		+ 0.5*a*c*d*e*V[0, 17] + 0.5*a*c*d*e*V[0, 22]*t1[0, 9] + a*c*d*f*V[0, 16]*t2[0, 12] + 0.5*a*c*d*f*V[0, 16] 
		+ 0.5*a*c*d*f*V[0, 25] + a*c*d*V[0, 4]*t2[0, 12] - 1.5*a*c*d*V[0, 21] - 0.5*a*c*d*V[0, 24] + 0.25*a*c*e**2*V[0, 26]*t0[0, 3] 
		+ a*c*e**2*V[0, 26]*t2[0, 4] + 0.5*a*c*e*f*V[0, 24] - 0.5*a*c*e*V[0, 16] - 1.5*a*c*e*V[0, 20] + 0.5*a*c*e*V[0, 25] 
		+ 0.5*a*c*f**2*V[0, 23] + 0.25*a*c*f**2*V[0, 26]*t0[0, 4] + a*c*f**2*V[0, 26]*t2[0, 10] + 0.5*a*c*f*V[0, 17] 
		- 1.5*a*c*f*V[0, 19] - 1.5*a*c*V[0, 5] + 0.5*a*c*V[0, 18] + 0.5*a*c*V[0, 23] + 0.25*a*c*V[0, 26]*t0[0, 6] 
		+ a*c*V[0, 26]*t2[0, 14] + 1.0*a*d**3*V[0, 9] + 0.5*a*d**3*V[0, 12]*t0[0, 0] + 0.25*a*d**3*V[0, 25]*t0[0, 2] 
		+ 1.0*a*d**2*e*V[0, 15] + 0.5*a*d**2*e*V[0, 21]*t1[0, 9] + 0.25*a*d**2*e*V[0, 24]*t0[0, 2] + 0.5*a*d**2*e*V[0, 27]*t1[0, 4] 
		+ 1.0*a*d**2*f*V[0, 14] + 0.25*a*d**2*f*V[0, 23]*t0[0, 2] + a*d**2*f*V[0, 26]*t2[0, 7] + 0.5*a*d**2*V[0, 3] 
		+ 0.25*a*d**2*V[0, 6]*t0[0, 2] + 1.0*a*d*e**2*V[0, 8] + 0.5*a*d*e**2*V[0, 20]*t1[0, 9] + 0.25*a*d*e**2*V[0, 25]*t0[0, 3] 
		+ 1.0*a*d*e*f*V[0, 13] + 0.5*a*d*e*f*V[0, 19]*t1[0, 9] + 0.5*a*d*e*V[0, 2] + 0.5*a*d*e*V[0, 5]*t1[0, 9] 
		- 0.5*a*d*e*V[0, 14] + 1.0*a*d*f**2*V[0, 7] + 0.25*a*d*f**2*V[0, 25]*t0[0, 4] + 0.5*a*d*f*V[0, 1] + 0.5*a*d*f*V[0, 15] 
		+ 1.0*a*d*V[0, 9] + 0.5*a*d*V[0, 12]*t0[0, 7] + 0.25*a*d*V[0, 25]*t0[0, 6] + 0.25*a*e**3*V[0, 24]*t0[0, 3] 
		+ 0.5*a*e**3*V[0, 27]*t1[0, 0] + 0.25*a*e**2*f*V[0, 23]*t0[0, 3] + a*e**2*f*V[0, 26]*t2[0, 8] 
		+ 0.25*a*e**2*V[0, 6]*t0[0, 3] - 0.5*a*e**2*V[0, 13] + 0.25*a*e*f**2*V[0, 24]*t0[0, 4] + 0.5*a*e*f**2*V[0, 27]*t1[0, 7] 
		- 1.0*a*e*f*V[0, 7] + 1.0*a*e*f*V[0, 8] - 0.5*a*e*V[0, 1] + 0.5*a*e*V[0, 15] + 0.25*a*e*V[0, 24]*t0[0, 6] 
		+ 0.5*a*e*V[0, 27]*t1[0, 10] + 0.25*a*f**3*V[0, 23]*t0[0, 4] + a*f**3*V[0, 26]*t2[0, 0] + 0.25*a*f**2*V[0, 6]*t0[0, 4] 
		+ 0.5*a*f**2*V[0, 13] + 0.5*a*f*V[0, 2] + 0.5*a*f*V[0, 14] + 0.25*a*f*V[0, 23]*t0[0, 6] + a*f*V[0, 26]*t2[0, 15] 
		+ 0.5*a*V[0, 3] + 0.25*a*V[0, 6]*t0[0, 6] + 1.0*b**4*V[0, 11]*t1[0, 1] + 0.5*b**3*c*V[0, 22]*t1[0, 1] 
		+ b**3*c*V[0, 22]*t2[0, 3] + 0.5*b**3*d*V[0, 21]*t1[0, 1] + 1.0*b**3*e*V[0, 11]*t1[0, 3] + 0.5*b**3*e*V[0, 20]*t1[0, 1] 
		+ 0.5*b**3*f*V[0, 19]*t1[0, 1] + b**3*f*V[0, 22]*t2[0, 9] + 0.5*b**3*V[0, 5]*t1[0, 1] + 2*b**2*c**2*V[0, 10]*t2[0, 3] 
		+ b**2*c*d*V[0, 18]*t2[0, 3] + b**2*c*e*V[0, 17]*t2[0, 3] + 0.5*b**2*c*e*V[0, 22]*t1[0, 3] + b**2*c*e*V[0, 22]*t2[0, 11] 
		+ 2*b**2*c*f*V[0, 10]*t2[0, 9] + b**2*c*f*V[0, 16]*t2[0, 3] + b**2*c*V[0, 4]*t2[0, 3] + 0.25*b**2*c*V[0, 27] 
		+ 1.0*b**2*d**2*V[0, 11]*t1[0, 2] + 0.5*b**2*d*e*V[0, 21]*t1[0, 3] + 0.5*b**2*d*e*V[0, 21] + 0.25*b**2*d*e*V[0, 27]*t0[0, 8] 
		+ b**2*d*f*V[0, 18]*t2[0, 9] + 0.5*b**2*d*V[0, 19] + 1.0*b**2*e**2*V[0, 11]*t1[0, 5] + 0.5*b**2*e**2*V[0, 20]*t1[0, 3] 
		+ 0.5*b**2*e**2*V[0, 20] + b**2*e*f*V[0, 17]*t2[0, 9] + 0.5*b**2*e*f*V[0, 19]*t1[0, 3] + 0.5*b**2*e*f*V[0, 19] 
		+ b**2*e*f*V[0, 22]*t2[0, 13] + 0.5*b**2*e*V[0, 5]*t1[0, 3] + 1.0*b**2*f**2*V[0, 11]*t1[0, 6] + b**2*f**2*V[0, 16]*t2[0, 9] 
		+ b**2*f*V[0, 4]*t2[0, 9] - 0.5*b**2*f*V[0, 21] + 1.0*b**2*V[0, 11]*t1[0, 11] + 0.5*b**2*V[0, 20] + b*c**3*V[0, 22]*t2[0, 1] 
		+ 2*b*c**2*e*V[0, 10]*t2[0, 11] + b*c**2*f*V[0, 22]*t2[0, 6] + 0.25*b*c**2*V[0, 26] + 0.5*b*c*d**2*V[0, 22]*t1[0, 2] 
		+ b*c*d*e*V[0, 18]*t2[0, 11] + 0.5*b*c*d*e*V[0, 18] + 0.25*b*c*d*e*V[0, 26]*t0[0, 8] + 0.5*b*c*d*f*V[0, 21] 
		+ 0.5*b*c*d*V[0, 16] - 0.5*b*c*d*V[0, 20] + 0.25*b*c*d*V[0, 25] + b*c*e**2*V[0, 17]*t2[0, 11] + 0.5*b*c*e**2*V[0, 17] 
		+ 0.5*b*c*e**2*V[0, 22]*t1[0, 5] + b*c*e**2*V[0, 22]*t2[0, 4] + 2*b*c*e*f*V[0, 10]*t2[0, 13] + b*c*e*f*V[0, 16]*t2[0, 11] 
		+ 0.5*b*c*e*f*V[0, 16] + 0.5*b*c*e*f*V[0, 20] + b*c*e*V[0, 4]*t2[0, 11] + 0.5*b*c*e*V[0, 21] + 0.25*b*c*e*V[0, 24] 
		+ 0.5*b*c*f**2*V[0, 19] + 0.5*b*c*f**2*V[0, 22]*t1[0, 6] + b*c*f**2*V[0, 22]*t2[0, 10] - 0.5*b*c*f*V[0, 18] 
		+ 0.25*b*c*f*V[0, 23] + 0.25*b*c*V[0, 6] + 0.5*b*c*V[0, 17] + 0.5*b*c*V[0, 19] + 0.5*b*c*V[0, 22]*t1[0, 11] 
		+ b*c*V[0, 22]*t2[0, 14] + 0.5*b*d**3*V[0, 21]*t1[0, 2] + 0.25*b*d**3*V[0, 27]*t0[0, 0] + 1.0*b*d**2*e*V[0, 9] 
		+ 1.0*b*d**2*e*V[0, 11]*t1[0, 4] + 0.5*b*d**2*e*V[0, 20]*t1[0, 2] + 0.25*b*d**2*e*V[0, 25]*t0[0, 8] + 0.5*b*d**2*f*V[0, 19]*t1[0, 2] 
		+ b*d**2*f*V[0, 22]*t2[0, 7] + 0.5*b*d**2*V[0, 5]*t1[0, 2] + 0.5*b*d**2*V[0, 14] + 1.0*b*d*e**2*V[0, 15] + 0.5*b*d*e**2*V[0, 21]*t1[0, 5] 
		+ 0.25*b*d*e**2*V[0, 24]*t0[0, 8] + 1.0*b*d*e*f*V[0, 14] + b*d*e*f*V[0, 18]*t2[0, 13] + 0.25*b*d*e*f*V[0, 23]*t0[0, 8] 
		+ 0.5*b*d*e*V[0, 3] + 0.25*b*d*e*V[0, 6]*t0[0, 8] + 0.5*b*d*e*V[0, 13] + 0.5*b*d*f**2*V[0, 21]*t1[0, 6] 
		+ 1.0*b*d*f*V[0, 7] - 1.0*b*d*f*V[0, 9] + 0.5*b*d*V[0, 1] + 0.5*b*d*V[0, 15] + 0.5*b*d*V[0, 21]*t1[0, 11] 
		+ 0.25*b*d*V[0, 27]*t0[0, 7] + 1.0*b*e**3*V[0, 8] + 1.0*b*e**3*V[0, 11]*t1[0, 0] + 0.5*b*e**3*V[0, 20]*t1[0, 5] 
		+ 1.0*b*e**2*f*V[0, 13] + b*e**2*f*V[0, 17]*t2[0, 13] + 0.5*b*e**2*f*V[0, 19]*t1[0, 5] + b*e**2*f*V[0, 22]*t2[0, 8] 
		+ 0.5*b*e**2*V[0, 2] + 0.5*b*e**2*V[0, 5]*t1[0, 5] + 1.0*b*e*f**2*V[0, 7] + 1.0*b*e*f**2*V[0, 11]*t1[0, 7] 
		+ b*e*f**2*V[0, 16]*t2[0, 13] + 0.5*b*e*f**2*V[0, 20]*t1[0, 6] + 0.5*b*e*f*V[0, 1] + b*e*f*V[0, 4]*t2[0, 13] 
		- 0.5*b*e*f*V[0, 15] + 1.0*b*e*V[0, 8] + 1.0*b*e*V[0, 11]*t1[0, 10] + 0.5*b*e*V[0, 20]*t1[0, 11] + 0.5*b*f**3*V[0, 19]*t1[0, 6] 
		+ b*f**3*V[0, 22]*t2[0, 0] + 0.5*b*f**2*V[0, 5]*t1[0, 6] - 0.5*b*f**2*V[0, 14] - 0.5*b*f*V[0, 3] + 0.5*b*f*V[0, 13] + 0.5*b*f*V[0, 19]*t1[0, 11] 
		+ b*f*V[0, 22]*t2[0, 15] + 0.5*b*V[0, 2] + 0.5*b*V[0, 5]*t1[0, 11] + 2*c**4*V[0, 10]*t2[0, 1] + c**3*d*V[0, 18]*t2[0, 1] + c**3*e*V[0, 17]*t2[0, 1] 
		+ 2*c**3*f*V[0, 10]*t2[0, 6] + c**3*f*V[0, 16]*t2[0, 1] + c**3*V[0, 4]*t2[0, 1] + c**2*d*f*V[0, 18]*t2[0, 6] 
		+ 0.5*c**2*d*f*V[0, 18] - 0.5*c**2*d*V[0, 17] + 2*c**2*e**2*V[0, 10]*t2[0, 4] + c**2*e*f*V[0, 17]*t2[0, 6] 
		+ 0.5*c**2*e*f*V[0, 17] + 0.5*c**2*e*V[0, 18] + 2*c**2*f**2*V[0, 10]*t2[0, 10] + c**2*f**2*V[0, 16]*t2[0, 6] 
		+ 0.5*c**2*f**2*V[0, 16] + c**2*f*V[0, 4]*t2[0, 6] + 2*c**2*V[0, 10]*t2[0, 14] + 0.5*c**2*V[0, 16] 
		+ 0.25*c*d**3*V[0, 26]*t0[0, 0] + 0.5*c*d**2*e*V[0, 22]*t1[0, 4] + 1.0*c*d**2*f*V[0, 9] 
		+ 2*c*d**2*f*V[0, 10]*t2[0, 7] - 0.5*c*d**2*V[0, 15] + c*d*e**2*V[0, 18]*t2[0, 4] + 1.0*c*d*e*f*V[0, 15] 
		- 1.0*c*d*e*V[0, 8] + 1.0*c*d*e*V[0, 9] + 1.0*c*d*f**2*V[0, 14] + c*d*f**2*V[0, 18]*t2[0, 10] + 0.5*c*d*f*V[0, 3] 
		- 0.5*c*d*f*V[0, 13] - 0.5*c*d*V[0, 2] + 0.5*c*d*V[0, 14] + c*d*V[0, 18]*t2[0, 14] + 0.25*c*d*V[0, 26]*t0[0, 7] 
		+ c*e**3*V[0, 17]*t2[0, 4] + 0.5*c*e**3*V[0, 22]*t1[0, 0] + 1.0*c*e**2*f*V[0, 8] + 2*c*e**2*f*V[0, 10]*t2[0, 8] 
		+ c*e**2*f*V[0, 16]*t2[0, 4] + c*e**2*V[0, 4]*t2[0, 4] + 0.5*c*e**2*V[0, 15] + 1.0*c*e*f**2*V[0, 13] + c*e*f**2*V[0, 17]*t2[0, 10] 
		+ 0.5*c*e*f**2*V[0, 22]*t1[0, 7] + 0.5*c*e*f*V[0, 2] + 0.5*c*e*f*V[0, 14] + 0.5*c*e*V[0, 3] + 0.5*c*e*V[0, 13] 
		+ c*e*V[0, 17]*t2[0, 14] + 0.5*c*e*V[0, 22]*t1[0, 10] + 1.0*c*f**3*V[0, 7] + 2*c*f**3*V[0, 10]*t2[0, 0] + c*f**3*V[0, 16]*t2[0, 10] 
		+ 0.5*c*f**2*V[0, 1] + c*f**2*V[0, 4]*t2[0, 10] + 1.0*c*f*V[0, 7] + 2*c*f*V[0, 10]*t2[0, 15] + c*f*V[0, 16]*t2[0, 14] 
		+ 0.5*c*V[0, 1] + c*V[0, 4]*t2[0, 14] + 0.25*d**4*V[0, 25]*t0[0, 0] + 0.5*d**3*e*V[0, 21]*t1[0, 4] + 0.25*d**3*e*V[0, 24]*t0[0, 0] 
		+ d**3*f*V[0, 18]*t2[0, 7] + 0.25*d**3*f*V[0, 23]*t0[0, 0] + 0.25*d**3*V[0, 6]*t0[0, 0] + 0.5*d**2*e**2*V[0, 20]*t1[0, 4] 
		+ d**2*e*f*V[0, 17]*t2[0, 7] + 0.5*d**2*e*f*V[0, 19]*t1[0, 4] + 0.5*d**2*e*V[0, 5]*t1[0, 4] + d**2*f**2*V[0, 16]*t2[0, 7] 
		+ d**2*f*V[0, 4]*t2[0, 7] + 0.25*d**2*V[0, 25]*t0[0, 7] + 0.5*d*e**3*V[0, 21]*t1[0, 0] + d*e**2*f*V[0, 18]*t2[0, 8] + 0.5*d*e*f**2*V[0, 21]*t1[0, 7] 
		+ 0.5*d*e*V[0, 21]*t1[0, 10] + 0.25*d*e*V[0, 24]*t0[0, 7] + d*f**3*V[0, 18]*t2[0, 0] + d*f*V[0, 18]*t2[0, 15] + 0.25*d*f*V[0, 23]*t0[0, 7] 
		+ 0.25*d*V[0, 6]*t0[0, 7] + 0.5*e**4*V[0, 20]*t1[0, 0] + e**3*f*V[0, 17]*t2[0, 8] + 0.5*e**3*f*V[0, 19]*t1[0, 0] 
		+ 0.5*e**3*V[0, 5]*t1[0, 0] + e**2*f**2*V[0, 16]*t2[0, 8] + 0.5*e**2*f**2*V[0, 20]*t1[0, 7] + e**2*f*V[0, 4]*t2[0, 8] 
		+ 0.5*e**2*V[0, 20]*t1[0, 10] + e*f**3*V[0, 17]*t2[0, 0] + 0.5*e*f**3*V[0, 19]*t1[0, 7] + 0.5*e*f**2*V[0, 5]*t1[0, 7] 
		+ e*f*V[0, 17]*t2[0, 15] + 0.5*e*f*V[0, 19]*t1[0, 10] + 0.5*e*V[0, 5]*t1[0, 10] + f**4*V[0, 16]*t2[0, 0] 
		+ f**3*V[0, 4]*t2[0, 0] + f**2*V[0, 16]*t2[0, 15] + f*V[0, 4]*t2[0, 15]
		if Lie > 0:
			LieTest = False
			# print(Lie)
	# print("pass 2")
...
if __name__ == '__main__':
	...
	def Ours():
		...
		for it in range(100):
			final_state, vt = SVG(c0, c1, c2)
			c0 += 1e-3*np.clip(vt[0], -1e2, 1e2)
			c1 += 1e-3*np.clip(vt[1], -1e2, 1e2)
			c2 += 1e-3*np.clip(vt[2], -1e2, 1e2)
			timer = Timer()
