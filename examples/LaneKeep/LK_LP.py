...
def BarrierLP(control_param, l, k, g, SVGOnly=False):
	...
	lambda_2 = cp.Variable((1, 44)) #Q1
	lambda_3 = cp.Variable((1, 44)) #Q2
	...
	constraints += [0.2*lambda_1[0, 0] + 0.2*lambda_1[0, 1] + 0.7*lambda_1[0, 2] - 0.3*lambda_1[0, 3] + 2.2*lambda_1[0, 4] - 1.8*lambda_1[0, 5] + 0.6*lambda_1[0, 6] - 0.2*lambda_1[0, 7] + 0.04*lambda_1[0, 8] + 0.04*lambda_1[0, 9] + 0.49*lambda_1[0, 10] + 0.09*lambda_1[0, 11] + 4.84*lambda_1[0, 12] + 3.24*lambda_1[0, 13] + 0.36*lambda_1[0, 14] + 0.04*lambda_1[0, 15] + 0.04*lambda_1[0, 16] + 0.14*lambda_1[0, 17] + 0.14*lambda_1[0, 18] - 0.06*lambda_1[0, 19] - 0.06*lambda_1[0, 20] - 0.21*lambda_1[0, 21] + 0.44*lambda_1[0, 22] + 0.44*lambda_1[0, 23] + 1.54*lambda_1[0, 24] - 0.66*lambda_1[0, 25] - 0.36*lambda_1[0, 26] - 0.36*lambda_1[0, 27] - 1.26*lambda_1[0, 28] + 0.54*lambda_1[0, 29] - 3.96*lambda_1[0, 30] + 0.12*lambda_1[0, 31] + 0.12*lambda_1[0, 32] + 0.42*lambda_1[0, 33] - 0.18*lambda_1[0, 34] + 1.32*lambda_1[0, 35] - 1.08*lambda_1[0, 36] - 0.04*lambda_1[0, 37] - 0.04*lambda_1[0, 38] - 0.14*lambda_1[0, 39] + 0.06*lambda_1[0, 40] - 0.44*lambda_1[0, 41] + 0.36*lambda_1[0, 42] - 0.12*lambda_1[0, 43] <= B[0, 0]+ objc]
	constraints += [0.2*lambda_1[0, 0] + 0.2*lambda_1[0, 1] + 0.7*lambda_1[0, 2] - 0.3*lambda_1[0, 3] + 2.2*lambda_1[0, 4] - 1.8*lambda_1[0, 5] + 0.6*lambda_1[0, 6] - 0.2*lambda_1[0, 7] + 0.04*lambda_1[0, 8] + 0.04*lambda_1[0, 9] + 0.49*lambda_1[0, 10] + 0.09*lambda_1[0, 11] + 4.84*lambda_1[0, 12] + 3.24*lambda_1[0, 13] + 0.36*lambda_1[0, 14] + 0.04*lambda_1[0, 15] + 0.04*lambda_1[0, 16] + 0.14*lambda_1[0, 17] + 0.14*lambda_1[0, 18] - 0.06*lambda_1[0, 19] - 0.06*lambda_1[0, 20] - 0.21*lambda_1[0, 21] + 0.44*lambda_1[0, 22] + 0.44*lambda_1[0, 23] + 1.54*lambda_1[0, 24] - 0.66*lambda_1[0, 25] - 0.36*lambda_1[0, 26] - 0.36*lambda_1[0, 27] - 1.26*lambda_1[0, 28] + 0.54*lambda_1[0, 29] - 3.96*lambda_1[0, 30] + 0.12*lambda_1[0, 31] + 0.12*lambda_1[0, 32] + 0.42*lambda_1[0, 33] - 0.18*lambda_1[0, 34] + 1.32*lambda_1[0, 35] - 1.08*lambda_1[0, 36] - 0.04*lambda_1[0, 37] - 0.04*lambda_1[0, 38] - 0.14*lambda_1[0, 39] + 0.06*lambda_1[0, 40] - 0.44*lambda_1[0, 41] + 0.36*lambda_1[0, 42] - 0.12*lambda_1[0, 43] >= B[0, 0]- objc]
	constraints += [-lambda_1[0, 0] + lambda_1[0, 1] - 0.4*lambda_1[0, 8] + 0.4*lambda_1[0, 9] - 0.7*lambda_1[0, 17] + 0.7*lambda_1[0, 18] + 0.3*lambda_1[0, 19] - 0.3*lambda_1[0, 20] - 2.2*lambda_1[0, 22] + 2.2*lambda_1[0, 23] + 1.8*lambda_1[0, 26] - 1.8*lambda_1[0, 27] - 0.6*lambda_1[0, 31] + 0.6*lambda_1[0, 32] + 0.2*lambda_1[0, 37] - 0.2*lambda_1[0, 38] <= B[0, 1]+ objc]
	constraints += [-lambda_1[0, 0] + lambda_1[0, 1] - 0.4*lambda_1[0, 8] + 0.4*lambda_1[0, 9] - 0.7*lambda_1[0, 17] + 0.7*lambda_1[0, 18] + 0.3*lambda_1[0, 19] - 0.3*lambda_1[0, 20] - 2.2*lambda_1[0, 22] + 2.2*lambda_1[0, 23] + 1.8*lambda_1[0, 26] - 1.8*lambda_1[0, 27] - 0.6*lambda_1[0, 31] + 0.6*lambda_1[0, 32] + 0.2*lambda_1[0, 37] - 0.2*lambda_1[0, 38] >= B[0, 1]- objc]
	constraints += [lambda_1[0, 8] + lambda_1[0, 9] - lambda_1[0, 16] <= B[0, 5]+ objc]
	constraints += [lambda_1[0, 8] + lambda_1[0, 9] - lambda_1[0, 16] >= B[0, 5]- objc]
	constraints += [-lambda_1[0, 2] + lambda_1[0, 3] - 1.4*lambda_1[0, 10] - 0.6*lambda_1[0, 11] - 0.2*lambda_1[0, 17] - 0.2*lambda_1[0, 18] + 0.2*lambda_1[0, 19] + 0.2*lambda_1[0, 20] + 1.0*lambda_1[0, 21] - 2.2*lambda_1[0, 24] + 2.2*lambda_1[0, 25] + 1.8*lambda_1[0, 28] - 1.8*lambda_1[0, 29] - 0.6*lambda_1[0, 33] + 0.6*lambda_1[0, 34] + 0.2*lambda_1[0, 39] - 0.2*lambda_1[0, 40] <= B[0, 2]+ objc]
	constraints += [-lambda_1[0, 2] + lambda_1[0, 3] - 1.4*lambda_1[0, 10] - 0.6*lambda_1[0, 11] - 0.2*lambda_1[0, 17] - 0.2*lambda_1[0, 18] + 0.2*lambda_1[0, 19] + 0.2*lambda_1[0, 20] + 1.0*lambda_1[0, 21] - 2.2*lambda_1[0, 24] + 2.2*lambda_1[0, 25] + 1.8*lambda_1[0, 28] - 1.8*lambda_1[0, 29] - 0.6*lambda_1[0, 33] + 0.6*lambda_1[0, 34] + 0.2*lambda_1[0, 39] - 0.2*lambda_1[0, 40] >= B[0, 2]- objc]
	constraints += [lambda_1[0, 17] - lambda_1[0, 18] - lambda_1[0, 19] + lambda_1[0, 20] <= B[0, 9]+ objc]
	constraints += [lambda_1[0, 17] - lambda_1[0, 18] - lambda_1[0, 19] + lambda_1[0, 20] >= B[0, 9]- objc]
	constraints += [lambda_1[0, 10] + lambda_1[0, 11] - lambda_1[0, 21] <= B[0, 6]+ objc]
	constraints += [lambda_1[0, 10] + lambda_1[0, 11] - lambda_1[0, 21] >= B[0, 6]- objc]
	constraints += [-lambda_1[0, 4] + lambda_1[0, 5] - 4.4*lambda_1[0, 12] - 3.6*lambda_1[0, 13] - 0.2*lambda_1[0, 22] - 0.2*lambda_1[0, 23] - 0.7*lambda_1[0, 24] + 0.3*lambda_1[0, 25] + 0.2*lambda_1[0, 26] + 0.2*lambda_1[0, 27] + 0.7*lambda_1[0, 28] - 0.3*lambda_1[0, 29] + 4.0*lambda_1[0, 30] - 0.6*lambda_1[0, 35] + 0.6*lambda_1[0, 36] + 0.2*lambda_1[0, 41] - 0.2*lambda_1[0, 42] <= B[0, 3]+ objc]
	constraints += [-lambda_1[0, 4] + lambda_1[0, 5] - 4.4*lambda_1[0, 12] - 3.6*lambda_1[0, 13] - 0.2*lambda_1[0, 22] - 0.2*lambda_1[0, 23] - 0.7*lambda_1[0, 24] + 0.3*lambda_1[0, 25] + 0.2*lambda_1[0, 26] + 0.2*lambda_1[0, 27] + 0.7*lambda_1[0, 28] - 0.3*lambda_1[0, 29] + 4.0*lambda_1[0, 30] - 0.6*lambda_1[0, 35] + 0.6*lambda_1[0, 36] + 0.2*lambda_1[0, 41] - 0.2*lambda_1[0, 42] >= B[0, 3]- objc]
	constraints += [lambda_1[0, 22] - lambda_1[0, 23] - lambda_1[0, 26] + lambda_1[0, 27] <= B[0, 10]+ objc]
	constraints += [lambda_1[0, 22] - lambda_1[0, 23] - lambda_1[0, 26] + lambda_1[0, 27] >= B[0, 10]- objc]
	constraints += [lambda_1[0, 24] - lambda_1[0, 25] - lambda_1[0, 28] + lambda_1[0, 29] <= B[0, 11]+ objc]
	constraints += [lambda_1[0, 24] - lambda_1[0, 25] - lambda_1[0, 28] + lambda_1[0, 29] >= B[0, 11]- objc]
	constraints += [1.0*lambda_1[0, 12] + 1.0*lambda_1[0, 13] - lambda_1[0, 30] <= B[0, 7]+ objc]
	constraints += [1.0*lambda_1[0, 12] + 1.0*lambda_1[0, 13] - lambda_1[0, 30] >= B[0, 7]- objc]
	constraints += [-lambda_1[0, 6] + lambda_1[0, 7] - 1.2*lambda_1[0, 14] - 0.4*lambda_1[0, 15] - 0.2*lambda_1[0, 31] - 0.2*lambda_1[0, 32] - 0.7*lambda_1[0, 33] + 0.3*lambda_1[0, 34] - 2.2*lambda_1[0, 35] + 1.8*lambda_1[0, 36] + 0.2*lambda_1[0, 37] + 0.2*lambda_1[0, 38] + 0.7*lambda_1[0, 39] - 0.3*lambda_1[0, 40] + 2.2*lambda_1[0, 41] - 1.8*lambda_1[0, 42] + 0.8*lambda_1[0, 43] <= B[0, 4]+ objc]
	constraints += [-lambda_1[0, 6] + lambda_1[0, 7] - 1.2*lambda_1[0, 14] - 0.4*lambda_1[0, 15] - 0.2*lambda_1[0, 31] - 0.2*lambda_1[0, 32] - 0.7*lambda_1[0, 33] + 0.3*lambda_1[0, 34] - 2.2*lambda_1[0, 35] + 1.8*lambda_1[0, 36] + 0.2*lambda_1[0, 37] + 0.2*lambda_1[0, 38] + 0.7*lambda_1[0, 39] - 0.3*lambda_1[0, 40] + 2.2*lambda_1[0, 41] - 1.8*lambda_1[0, 42] + 0.8*lambda_1[0, 43] >= B[0, 4]- objc]
	constraints += [lambda_1[0, 31] - lambda_1[0, 32] - lambda_1[0, 37] + lambda_1[0, 38] <= B[0, 12]+ objc]
	constraints += [lambda_1[0, 31] - lambda_1[0, 32] - lambda_1[0, 37] + lambda_1[0, 38] >= B[0, 12]- objc]
	constraints += [lambda_1[0, 33] - lambda_1[0, 34] - lambda_1[0, 39] + lambda_1[0, 40] <= B[0, 13]+ objc]
	constraints += [lambda_1[0, 33] - lambda_1[0, 34] - lambda_1[0, 39] + lambda_1[0, 40] >= B[0, 13]- objc]
	...
	constraints += [-lambda_2[0, 0] + lambda_2[0, 4] - 6*lambda_2[0, 8] + 6*lambda_2[0, 12] - 3*lambda_2[0, 16] - 3*lambda_2[0, 17] - 3*lambda_2[0, 19] + 3*lambda_2[0, 23] + 3*lambda_2[0, 24] + 3*lambda_2[0, 25] - 3*lambda_2[0, 26] + 3*lambda_2[0, 30] - 3*lambda_2[0, 31] + 3*lambda_2[0, 35] - 3*lambda_2[0, 37] + 3*lambda_2[0, 41] >= g*B[0, 1] + k*B[0, 3] - l*B[0, 1] + 16.3*B[0, 1]*t[0, 3] + B[0, 2] + 40*B[0, 3]*t[0, 3]- objc]
	constraints += [lambda_2[0, 8] + lambda_2[0, 12] - lambda_2[0, 22] <= 2*g*B[0, 5] + k*B[0, 10] - l*B[0, 5] + 32.6*B[0, 5]*t[0, 3] + B[0, 9] + 40*B[0, 10]*t[0, 3] - 0.001+ objc]
	constraints += [lambda_2[0, 8] + lambda_2[0, 12] - lambda_2[0, 22] >= 2*g*B[0, 5] + k*B[0, 10] - l*B[0, 5] + 32.6*B[0, 5]*t[0, 3] + B[0, 9] + 40*B[0, 10]*t[0, 3] - 0.001- objc]
	...
	constraints += [lambda_2[0, 16] - lambda_2[0, 23] - lambda_2[0, 26] + lambda_2[0, 30] >= g*B[0, 9] + k*B[0, 11] - l*B[0, 9] + 32.6*B[0, 5]*t[0, 2] + 2*B[0, 6] + 16.3*B[0, 9]*t[0, 3] + 40*B[0, 10]*t[0, 2] + 40*B[0, 11]*t[0, 3] + 13.4*B[0, 12]- objc]
	constraints += [lambda_2[0, 9] + lambda_2[0, 13] - lambda_2[0, 27] <= -l*B[0, 6] + 16.3*B[0, 9]*t[0, 2] + 40*B[0, 11]*t[0, 2] + 13.4*B[0, 13] - 0.001+ objc]
	constraints += [lambda_2[0, 9] + lambda_2[0, 13] - lambda_2[0, 27] >= -l*B[0, 6] + 16.3*B[0, 9]*t[0, 2] + 40*B[0, 11]*t[0, 2] + 13.4*B[0, 13] - 0.001- objc]
	...
	constraints += [lambda_2[0, 18] - lambda_2[0, 28] - lambda_2[0, 32] + lambda_2[0, 36] >= -l*B[0, 11] + 80*B[0, 7]*t[0, 2] + 16.3*B[0, 9]*t[0, 1] + 0.925*B[0, 9] + 16.3*B[0, 10]*t[0, 2] + 40*B[0, 11]*t[0, 1] - 6.5*B[0, 11] + B[0, 13] + 13.4*B[0, 14]- objc]
	constraints += [lambda_2[0, 10] + lambda_2[0, 14] - lambda_2[0, 33] <= -l*B[0, 7] + 80*B[0, 7]*t[0, 1] - 13.0*B[0, 7] + 16.3*B[0, 10]*t[0, 1] + 0.925*B[0, 10] + B[0, 14] - 0.001+ objc]
	constraints += [lambda_2[0, 10] + lambda_2[0, 14] - lambda_2[0, 33] >= -l*B[0, 7] + 80*B[0, 7]*t[0, 1] - 13.0*B[0, 7] + 16.3*B[0, 10]*t[0, 1] + 0.925*B[0, 10] + B[0, 14] - 0.001- objc]
	...
	constraints += [lambda_2[0, 21] - lambda_2[0, 34] - lambda_2[0, 39] + lambda_2[0, 43] >= -l*B[0, 14] + 80*B[0, 7]*t[0, 0] + 2*B[0, 8] + 16.3*B[0, 10]*t[0, 0] + 16.3*B[0, 12]*t[0, 1] + 0.925*B[0, 12] + 40*B[0, 14]*t[0, 1] - 6.5*B[0, 14]- objc]
	constraints += [lambda_2[0, 11] + lambda_2[0, 15] - lambda_2[0, 40] <= -l*B[0, 8] + 16.3*B[0, 12]*t[0, 0] + 40*B[0, 14]*t[0, 0] - 0.001+ objc]
	constraints += [lambda_2[0, 11] + lambda_2[0, 15] - lambda_2[0, 40] >= -l*B[0, 8] + 16.3*B[0, 12]*t[0, 0] + 40*B[0, 14]*t[0, 0] - 0.001- objc]
	...
	constraints += [-lambda_3[0, 0] + lambda_3[0, 1] - 4*lambda_3[0, 8] + 2*lambda_3[0, 16] - lambda_3[0, 17] + lambda_3[0, 18] - lambda_3[0, 19] + lambda_3[0, 20] - 3*lambda_3[0, 22] + 3*lambda_3[0, 23] + lambda_3[0, 26] - lambda_3[0, 27] - 3*lambda_3[0, 31] + 3*lambda_3[0, 32] + lambda_3[0, 37] - lambda_3[0, 38] >= -B[0, 1]- objc]
	constraints += [lambda_3[0, 8] + lambda_3[0, 9] - lambda_3[0, 16] <= -B[0, 5] - 0.0001+ objc]
	constraints += [lambda_3[0, 8] + lambda_3[0, 9] - lambda_3[0, 16] >= -B[0, 5] - 0.0001- objc]
	...
	constraints += [lambda_3[0, 17] - lambda_3[0, 18] - lambda_3[0, 19] + lambda_3[0, 20] >= -B[0, 9]- objc]
	constraints += [lambda_3[0, 10] + lambda_3[0, 11] - lambda_3[0, 21] <= -B[0, 6] - 0.0001+ objc]
	constraints += [lambda_3[0, 10] + lambda_3[0, 11] - lambda_3[0, 21] >= -B[0, 6] - 0.0001- objc]
	...
	constraints += [lambda_3[0, 24] - lambda_3[0, 25] - lambda_3[0, 28] + lambda_3[0, 29] >= -B[0, 11]- objc]
	constraints += [lambda_3[0, 12] + lambda_3[0, 13] - lambda_3[0, 30] <= -B[0, 7] - 0.0001+ objc]
	constraints += [lambda_3[0, 12] + lambda_3[0, 13] - lambda_3[0, 30] >= -B[0, 7] - 0.0001- objc]
	...
	constraints += [lambda_3[0, 35] - lambda_3[0, 36] - lambda_3[0, 41] + lambda_3[0, 42] >= -B[0, 14]- objc]
	constraints += [lambda_3[0, 14] + lambda_3[0, 15] - lambda_3[0, 43] <= -B[0, 8] - 0.0001+ objc]
	constraints += [lambda_3[0, 14] + lambda_3[0, 15] - lambda_3[0, 43] >= -B[0, 8] - 0.0001- objc]
...
def BarrierTest(Barrier_param, control_param, l, k, g):
	...
	for i in range(10000):
		...
		while (y - 0.4)**2 + (v_y - 2)**2 + (phi_e - 0.5)**2 + r**2 > 0.01:
			...
			phi_e = np.random.uniform(low=0.4, high=0.6, size=1)[0]
			r = np.random.uniform(low=-0.1, high=0.1, size=1)[0]
		initBarrier = Barrier_param.dot(np.array([1, r, phi_e, v_y, y, r**2, phi_e**2, v_y**2, y**2, phi_e*r, r*v_y, phi_e*v_y, r*y, phi_e*y, v_y*y]))
		if initBarrier < 0:
			initTest = False
		...
		while (y-2)**2 + (v_y-2)**2 + phi_e**2 + (r-1)**2 > 1:
			...
			phi_e = np.random.uniform(low=-1, high=1, size=1)[0]
			r = np.random.uniform(low=0, high=2, size=1)[0]
		unsafeBarrier = Barrier_param.dot(np.array([1, r, phi_e, v_y, y, r**2, phi_e**2, v_y**2, y**2, phi_e*r, r*v_y, phi_e*v_y, r*y, phi_e*y, v_y*y]))
		if unsafeBarrier > 0:
			unsafeTest = False
		...
		B = np.reshape(Barrier_param, (1, 15))
	...
	for i in range(N):
		...
		for _ in range(env.max_iteration):
			...
			if i >= 5:
				...
				BarrierValue.append(-B.dot(np.array([1, r, phi_e,v_y, y, r**2, phi_e**2, v_y**2, y**2, phi_e*r, r*v_y, phi_e*v_y, r*y, phi_e*y, v_y*y])))
