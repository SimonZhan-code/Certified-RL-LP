...
def BarrierLP(t0, timer, SVG_only=False):
	...
	theta_t0 = torch.from_numpy(t0).float()
...
if __name__ == '__main__':
	...
	def Barrier_SVG():
		...
		control_param = np.array([0, 0, 0], dtype='float64')
		for i in range(100):
